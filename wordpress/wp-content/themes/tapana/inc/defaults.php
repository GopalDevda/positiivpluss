...
if ( ! function_exists( 'martanda_get_defaults' ) ) {
	...
	function martanda_get_defaults() {
		$martanda_defaults = array(
			...
			'text_color' => '#1c1c1c',
			'link_color' => '#d72222',
			'link_color_hover' => '#1c1c1c',
			'side_inside_color' => '',
			'header_background_color' => '',
			'header_text_color' => '#ffffff',
			'header_link_color' => '#d72222',
			'header_link_hover_color' => '#ffffff',
			'sticky_header_background_color' => '#1c1c1c',
			'site_title_color' => '#d72222',
			'navigation_background_color' => '',
			'navigation_text_color' => '#ffffff',
			'navigation_background_hover_color' => '',
			'navigation_text_hover_color' => '#d72222',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '#ffffff',
			'subnavigation_background_color' => '#1c1c1c',
			'subnavigation_text_color' => '#ffffff',
			'subnavigation_background_hover_color' => '#1c1c1c',
			'subnavigation_text_hover_color' => '#d72222',
			'subnavigation_background_current_color' => '#1c1c1c',
			'subnavigation_text_current_color' => '#ffffff',
			'form_button_background_color' => '#1c1c1c',
			'form_button_text_color' => '#ffffff',
			'form_button_background_color_hover' => '#d72222',
			'form_button_text_color_hover' => '#ffffff',
			'form_button_border_color' => '#1c1c1c',
			'form_button_border_color_hover' => '#1c1c1c',
			'fixed_side_content_background_color' => '#1c1c1c',
			'fixed_side_content_text_color' => '#ffffff',
			'fixed_side_content_link_color' => '#ffffff',
			'fixed_side_content_link_hover_color' => '#ffffff',
			'back_to_top_background_color' => '#1c1c1c',
			'back_to_top_background_color_hover' => '#d72222',
			...
			'footer_link_color' => '#d72222',
			'footer_link_hover_color' => '#1c1c1c',
			'scrollbar_track_color' => '#1c1c1c',
			'scrollbar_thumb_color' => '#d72222',
			'scrollbar_thumb_hover_color' => '#d72222',
			'wc_sale_sticker_background' => '#d72222',
			'wc_sale_sticker_text' => '#ffffff',
			'wc_price_color' => '#1c1c1c',
			'wc_product_tab' => '#555555',
			'wc_product_tab_highlight' => '#1c1c1c',
