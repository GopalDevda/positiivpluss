...
// print_r($data['sensor_notConnect']);
// die();
                  ...
                  $data.='<div class="col-md-2">
                     ...
                     <input type="number" id="llll" class="form-control total_number" 
                      placeholder="Value" value="'.$data_show['value'].'"
                       ...
                       onclick="Valueclickff(this);" readonly="">
                    </div>
...
$history_data = $energy_managment->where('supplier_id',$u_id)->where('status',1)->orderBy('id', 'desc')->groupBy('created_at')->findAll();
...
$energy_history_delete = $Energy->where('status',1)->where('energy',$history_energy)->where('supplier_id',$u_id)->where('type',$history_type)->where('sub_e_type',$history_sub_type)->findAll();
