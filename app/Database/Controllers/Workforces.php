    ...
    public function createemployee() {
     ...
     helper(['form', 'url']);
      ...
      $check = $this->validate([
       ...
       if($department==""){$department="Positiivplus";}
