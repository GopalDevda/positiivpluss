...
class AddvanceMasterController extends BaseController
...
$newName="none.phg";
   ...
   public function addIndicator(){
    ...
    public function deleteAdvanceAssessment($id) {
        ...
        if($advancedassessment_model->where(['id' => $id])->set(['status' => 0])->update()){



            $session->setFlashdata('success','Advance Assessment Question has been successfully deleted');
        ...
        return redirect()->to('AddvanceMasterController/assessment');
...
public function getIndicatorByIndicatorCategorymaster($id){
    ...
    public function addadvanceAssessment() {
        ...
        return view('admin/add-advance-assessment.php',$data);
    ...
    public function addAdvancedAssessmentSubmit() {
    ...
    //   $indicator_id = $this->request->getVar('indicator_id');
      ...
      $ava = $db->query("select * from advancedassessment where assessment_name='".$name."' and status=1");
            ...
            $ava_ext = array("png", "jpg", "jpeg", "gif");
                ...
                if(in_array($ext,$ava_ext)){
                    ...
                    if($file->move('public/uploads/assessment',$newName)){
                        ...
                        if($advancedassessment_model->insert($data)){
    ...
    public function assessment() {
        ...
        $data['list'] = $advancedassessment_model->select("*")->where('status',1)->findAll();



        return view('admin/advancedassessment.php',$data);
    ...
    public function editAdvanceAssessment($id) {

        $data=$this->helperData;

        $assessment_model = new AdvancedAssessment();
        
        $db = \Config\Database::connect();

        $rs = $db->query("select * from advancedassessment where id=".$id);
        ...
        return view('admin/edit-advance-assessment.php',$data);
    ...
    public function updateAdvanceAssessment() {
      ...
      $ava = $db->query("select * from advancedassessment where assessment_name='".$name."' and status=1 and id!=".$id);
...
// }
  ...
  if($ghg_factor) {
                ...
                $data.='<table class="table table-bordered"><tr><th>Sno </th><th>Connected GHGs</th></tr>';  
                                    ...
                                    }else{$data='Connect-it first To See It';  }
        echo $data;
...
// for getting factors on ghg selection
    ...
    public function setadvanceassessmemntaccess($assessment_id,$assessmemntaccess) {

          $advancedassessment_model = new AdvancedAssessment();

        if($advancedassessment_model->where(['id' => $assessment_id])->set(['assessmemnt_access' => $assessmemntaccess])->update()) {
