            ...
            <div class="col-md-12">
                ...
                <div class="step_content">                    
                    ...
                    <div class="single_q">
                        ...
                        <input type="hidden" name="supplier_id" value="<?php echo $supplier['plan_id'];?>" id='supplier_id'>
                        <input type="hidden" name="plan_id" value="<?php echo $supplier['supplier_id'];?>" id='supplier_id'>
...
<!--                            <div class="single_q">                                
                            ...
                            <div class="single_q">
                                ...
                                <div class="form_field join_btn btn_link golden_btn mt-2" ><input type="submit" name="submit" value="Next">
