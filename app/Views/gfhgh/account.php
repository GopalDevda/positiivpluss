                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-12">
                                            <ul class="nav nav-pills flex-column nav-left mb-2">
                                                <!-- account -->
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="stacked-pill-1" data-bs-toggle="pill" href="#vertical-pill-1"
                                                        aria-expanded="true">
                                                ...
                                                <!-- security -->
                                                <li class="nav-item">
                                                    <a class="nav-link" id="stacked-pill-2" data-bs-toggle="pill" href="#vertical-pill-2"
                                                        aria-expanded="false">
                                                ...
                                                <!-- billing and plans -->
                                                <li class="nav-item">
                                                    <a class="nav-link" id="stacked-pill-3" data-bs-toggle="pill" href="#vertical-pill-3"
                                                        aria-expanded="false">
                                                ...
                                                <!-- notification -->
                                                <li class="nav-item">
                                                    <a class="nav-link" id="stacked-pill-4" data-bs-toggle="pill" href="#vertical-pill-4"
                                                        aria-expanded="false">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="d-flex align-items-end mt-75 ms-1">
                                                                    <div>
                                                                        ...
                                                                        <button onclick="ImageShow(this)" for="account-upload"
                                                                        class="btn btn-sm btn-primary mb-75 me-75">Upload</button>
                                                            ...
                                                            <form class="validate-form mt-2 pt-50">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        ...
                                                                        name="firstName" placeholder="John" readonly value="<?php echo $ok['supplier_name']; ?>"
                                                                        data-msg="Please enter first name" />
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountPhoneNumber">Phone Number</label>
                                                                        <input type="hidden" class="form-control" id="accountLastName"
                                                                        name="lastName" placeholder="Doe" value="<?php echo $ok['last_name']; ?>"
                                                                        data-msg="Please enter last name" />
                                                                        <input readonly type="text" class="form-control account-number-mask"
                                                                        id="accountPhoneNumber" name="phoneNumber"
                                                                        placeholder="Phone Number" value="<?php echo $ok['mobile']; ?>" />
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountEmail">Email</label>
                                                                        <input readonly type="email" class="form-control" id="accountEmail" name="email"
                                                                        placeholder="Email" value="<?php echo $ok['email']; ?>" />
                                                                    </div>
                                                                    <!-- <div class="col-12 col-sm-6 mb-1">
                                                            ...
                                                            <form class="validate-form pt-50">
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        ...
                                                                        <input type="password" class="form-control" id="accountOrganization"
                                                                        name="organization" placeholder="Organization name"
                                                                        value="PIXINVENT" />
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                            ...
                                                            <form class="validate-form pt-50" name="RegForm" action="<?php echo base_url()?>/brand/information2" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        ...
                                                                        value="<?php echo $o['designation'];?>" >
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountOrganization">Date of Birth</label>
                                                                        <input type="date" class="form-control" id="age" name="age"
                                                                        placeholder="John" value="<?php echo $o['age']; ?>" data-msg="" />
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountOrganization">Department</label>
                                                                        <input type="text" class="form-control" id="department" name="department" value="<?php echo $o['department']; ?>">
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountOrganization">Country</label>
                                                                        <select id="country" name="country_name" class="select2 form-select">
                                                                            <option value="">Select Country</option>
                                                                            <?php
                                                                            foreach($country as $count){
                                                                            ?>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        ...
                                                                        <input type="date" class="form-control" id="datejoin"
                                                                        name="datejoin" placeholder="Joining Date" value="<?php echo $o['date_joining']; ?>" data-msg="" />
                                                                    </div>
                                                                    <?php   }
                                                                    else { ?>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountOrganization">Date of Joining</label>
                                                                        <input type="date" disabled class="form-control" id="datejoin"
                                                                        name="datejoin" placeholder="Joining Date" value="<?php echo $o['date_joining']; ?>" data-msg="" />
                                                                    </div>
                                                                    <?php    }?>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                    ...
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        <label class="form-label" for="accountOrganization">Employee Code</label>
                                                                        <input type="text" class="form-control" id="employeecode"
                                                                        name="employeecode" placeholder="John" value="<?php echo $o['employee_code']; ?>" data-msg="" />
                                                                    </div>
                                                                    <?php   }
                                                                    else { ?>
                                                                    <div class="col-12 col-sm-6 mb-1" >
                                                                        <label class="form-label" for="accountOrganization">Employee Code</label>
                                                                        <input  type="text" class="form-control" id="employeecode"
                                                                        name="employeecode"  value="<?php echo $o['employee_code']; ?>" data-msg="" />
                                                                    </div>
                                                                    <?php }?>
                                                                    <div class="col-12 col-sm-6 mb-1">
                                                                        ...
                                                                        value="<?php echo $o['current_address']; ?>">
                                                                    </div>
                                                                        ...
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="d-flex align-items-end mt-75 ms-1">
                                                                                <div>
                                                                                    ...
                                                                                    <p onclick="proof_inden()" for="account-upload"
                                                                                    class="btn btn-sm btn-primary mb-75 me-75">Upload</p>
                                                                        ...
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="d-flex align-items-end mt-75 ms-1">
                                                                                <div>
                                                                                    ...
                                                                                    <p onclick="address_proof()" for="account-upload"
                                                                                    class="btn btn-sm btn-primary mb-75 me-75">Upload</p>
                                                                                    <!--  <button  id="account-reset"
                                                                                    class="btn btn-sm btn-outline-secondary mb-75">Reset</button> -->
                                                                                    <!-- <p class="mb-0">Allowed file types: png, jpg, jpeg.</p> -->
...
progressBar: !0,
                        ...
                        // alert(accountLastName);
                        var accountEmail = $("#accountEmail").val();
                        var accountOrganization = $("#accountOrganization").val();
