            ...
            <ul class="list-group list-group-flush card">
               <?php foreach ($notiData as $redNoti) { ?>
                  <?php if ($redNoti['noti_read'] == 0) { ?>
                     <li class="list-group-item">
                        <p> <span class="text-success" style="font-size: 40px; font-weight: bolder;"> . </span> <?= $redNoti['msg'] ?>
                           <span class="float-end"><span class="fw-bolder">Date</span><small class="notification-text"> <?= substr($redNoti['created_at'], 0, 10) ?></small>
                              <span class="fw-bolder">Time</span><small class="notification-text"> <?= substr($redNoti['created_at'], 11) ?></small>
                           </span>
                        </p>
                     </li>
                  <?php } ?>
               ...
               <?php foreach ($notiData as $greenNoti) { ?>
                  <?php if ($greenNoti['noti_read'] == 1) { ?>
                     <li class="list-group-item">
                        <p> <span class="text-danger" style="font-size: 40px; font-weight: bolder;"> . </span> <?= $redNoti['msg'] ?>
                           <span class="float-end"><span class="fw-bolder">Date</span><small class="notification-text"> <?= substr($redNoti['created_at'], 0, 10) ?></small>
                              <span class="fw-bolder">Time</span><small class="notification-text"> <?= substr($redNoti['created_at'], 11) ?></small>
                           </span>
                        </p>
