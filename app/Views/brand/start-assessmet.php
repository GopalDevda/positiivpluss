            ...
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <a href='<?= base_url('Controlwork/assessment_view_supplier'); ?>' class='btn btn-primary float-end mx-2'>Back</a>
            ...
            <div class="row mt-4">
                ...
                ?>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="card mb-4">
                                <a href="<?= base_url('Controlwork/answerQuestion') ?>/<?= $row['select_question_id']; ?>/<?= $row['indicator_id'] ?>/<?= $id; ?>" class="myblock1">
                                    <div class="card-body">
                                        <div class="cs_icon">
                                            <?php
                                        ...
                                        <div class="d-flex justify-content-between mt-1">
                                            ...
                                            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Checked" class="avatar avatar-sm pull-up">
                                                    <?php
                                                    ...
                                                    <?php } else { ?>
                                                        <img class="rounded-circle" src="<?php echo base_url('public/brand/assets/app-assets/images/q_blank.png?v=1') ?>" alt="Avatar" />
                                                    <?php } ?>
                                                </li>
                                            </ul>
                                        </div>
                ...
                if ($total_A == $total_Q) { ?>
                    <div>
                        <a href="<?= base_url("Controlwork/completeAssessment"); ?>/<?= $id; ?>/<?= $total_per; ?>" class='btn btn-primary mt-1 float-end' onclick="return confirm('Are you sure')">Complete
                            Assessment</a>
                    </div>
                <?php } ?>
