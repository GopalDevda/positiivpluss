...
<div class="modal fade text-start" id="docDeletePopup" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="deleteassessment" action="<?php echo base_url() ?>/Controlwork/deleteAssessment" method="post" enctype="multipart/form-data">
                    <div class="row">
...
<div class="app-content content">
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <a href="<?= base_url('Controlwork/assessment'); ?>" class="btn btn-primary float-end">
                    Back</a>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="card myblock">
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div class="" style="height: 120px;">
                                <h3 class="fw-bolder mb-75 font_color"><?= $avarage; ?>%</h3>
                                <h3 class="text-white mt-2">Average Score </h3>
                            </div>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="card myblock">
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="fw-bolder mb-75 font_color">Top Scores
                                    <span class="fas fa-chevron-up" style="margin-left: 80px;" data-fa-transform="up-3"></span>
                                </h3>
                                <div class="row d-flex align-items-center">

                                    <div class="col-md-9">
                                        <?php
                                        if (isset($gaa[0][0])) echo '<h5 class="text-white">' . $gaa[0][0] . '</h5>';
                                        if (isset($gaa[1][0])) echo '<h5 class="text-white">' . $gaa[1][0] . '</h5>';
                                        if (isset($gaa[2][0])) echo '<h5 class="text-white">' . $gaa[2][0] . '</h5>';
                                        ?>
                                    </div>
                                    <div class="col-md-3">
                                        <?php
                                        ...
                                        if (isset($gaa[0][1])) echo '<h5><span class="badge bg-light-success text-white">' . number_format($gaa[0][1], 2) . '%</span></h5>';
                                        if (isset($gaa[1][1])) echo '<h5><span class="badge bg-light-success text-white">' . number_format($gaa[1][1], 2) . '%</span></h5>';
                                        if (isset($gaa[2][1])) echo '<h5><span class="badge bg-light-success text-white">' . number_format($gaa[2][1], 2) . '%</span></h5>';
                                        ?>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="card myblock">
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="fw-bolder mb-75 font_color">Bottom Scores
                                    <span class="fas fa-chevron-down" style="margin-left: 50px;" data-fa-transform="down-3"></span>
                                </h3>
                                <div class="row d-flex align-items-center">
                                    <div class="col-md-9">
                                        <?php
                                        if ($g_siz > 3) echo '<h5 class="text-white">' . $gaa[$g_siz - 1][0] . '</h5>';
                                        if ($g_siz > 4) echo '<h5 class="text-white">' . $gaa[$g_siz - 2][0] . '</h5>';
                                        if ($g_siz > 5) echo '<h5 class="text-white">' . $gaa[$g_siz - 3][0] . '</h5>';
                                        ?>
                                    </div>
                                    <div class="col-md-3">
                                        <?php
                                        if ($g_siz > 3) echo '<h5><span class="badge bg-light-danger text-white">' . number_format($gaa[$g_siz - 1][1], 2) . '%</span></h5>';
                                        if ($g_siz > 4) echo '<h5><span class="badge bg-light-danger text-white">' . number_format($gaa[$g_siz - 2][1], 2) . '%</span></h5>';
                                        if ($g_siz > 5) echo '<h5><span class="badge bg-light-danger text-white">' . number_format($gaa[$g_siz - 3][1], 2) . '%</span></h5> ';
                                        ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php if (!empty($supplierType)) {
                                                        foreach ($supplierType as $dd) {
                                                            echo $dd['id'] == $row['addsupplier_id'] ? $dd['company_name'] : '';
                                                        }
                                                    } ?></td>

                                                <td> <?php if (!empty($supplierType)) {
                                                            foreach ($supplierType as $dd) {
                                                                echo $dd['id'] == $row['addsupplier_id'] ? $dd['name'] : '';
                                                            }
                                                        } ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="progress" role="progressbar" data-toggle="tooltip" title="<?= $row['progress_bar']  ?>%" aria-valuenow="25" aria-valuemin="100" aria-valuemax="100">
                                                        <div class="progress-bar" style="width: <?= $row['progress_bar']  ?>%"></div>

                                                    </div>
                                                    <p><?= $row['progress_bar']  ?>%</p>
                                                </td>
                                                ...
                                                <td>
                                                    <?php if (!empty($supplier_industry)) {
                                                        foreach ($supplier_industry as $dd) {
                                                            echo $dd['id'] == $row['addsupplier_id'] ? $dd['industry_name'] : '';
                                                        }
                                                    } ?>
                                                </td>
                                                <td>
                            ...
                            <div class="tab-pane" id="profile1" aria-labelledby="profile-tab1" role="tabpanel">
                                <table class="table table-bordered example">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($control_assessment_complete as $key => $row) {
                                        ?>
                                            <tr>
                                                <td><?= ++$key; ?>
                                                    <span class="badge rounded-pill badge-light-primary"><?php echo $row['uniq_spl'] ?></span>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            ?>
                                                                ...
                                                                if ($roleAllow) {
                                                                    if ($roleAllow['view'] == 1) { ?>
                                                                        <a class="dropdown-item" href="<?php echo base_url('Controlwork/assessment_report') ?>/<?= $com ?>/<?= $row['id']; ?>">
                                                                            <i class="fa solid fa-eye me-50"></i>
                                                                            <span>View Result</span>
                                                                        </a>
                                                                    <?php }
        ...
        $('#deleteassessment').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    toastr.success("👋 Assessment delete successfully", "Success", {
                        closeButton: !0,
                        tapToDismiss: !1,
                        progressBar: !0,
                    })
