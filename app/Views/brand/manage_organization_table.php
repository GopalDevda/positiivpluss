  ...
  <div class="card-body card-datatable table-responsive pt-0">
    <ul class="nav nav-tabs" role="tablist">
      ...
      <?php if (!($role == 11)) { ?>
        ...
        <li class="nav-item me-3">
          <a class="nav-link" id="field-tab1" data-bs-toggle="tab" href="#field" aria-controls="field" role="tab" aria-selected="true">3rd feed</a>
        </li>
        <li class="nav-item me-3">
...
<?php }
      ...
      <div class="tab-pane" id="Boundaries" aria-labelledby="Boundaries-tab1" role="tabpanel">
        ...
        <section class="card overflow-hidden">
          <div class="row">
            <div class="card-body m-1 logistics-fleet-sidebar-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?= $product['cp_collection'] ?></td>
                        <td><?= $product['cp_sku'] ?></td>
                        <td>
                        ...
                        <td class="control" tabindex="0" onclick="view_product(<?= $product['id'] ?>)"><button class="btn btn-secondary"> View</button></td>
                        <!-- <td>
                  <div class="dropdown">
                    ...
                    <div class="accordion accordion-margin" id="accordionMargin">
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarginOne">
                          <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMarginOne" aria-expanded="false" aria-controls="accordionMarginOne">
                            <div class="indicator">
                              <img src="https://positiivplus.com/public/uploads/sdg/1625656128_d4cd87957eaac066935d.png" alt="Indicator 1" width="50px" class="rounded-circle">
                            </div>
                            <div class="indicator-info ps-1 me-auto">
                              <p class="indicator-name mb-0">Indicator</p>
                              <span class="indicator-category">Category</span>
                            </div>
                          </button>
                        </h2>
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarginTwo">
                          <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMarginTwo" aria-expanded="false" aria-controls="accordionMarginTwo">
                            <div class="indicator">
                              <img src="https://positiivplus.com/public/uploads/sdg/1625656128_d4cd87957eaac066935d.png" alt="Indicator 1" width="50px" class="rounded-circle">
                            </div>
                            <div class="indicator-info ps-1 me-auto">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarginThree">
                          <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMarginThree" aria-expanded="false" aria-controls="accordionMarginThree">
                            <div class="indicator">
                              <img src="https://positiivplus.com/public/uploads/sdg/1625656128_d4cd87957eaac066935d.png" alt="Indicator 1" width="50px" class="rounded-circle">
                            </div>
                            <div class="indicator-info ps-1 me-auto">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarginFour">
                          <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMarginFour" aria-expanded="false" aria-controls="accordionMarginFour">
                            <div class="indicator">
                              <img src="https://positiivplus.com/public/uploads/sdg/1625656128_d4cd87957eaac066935d.png" alt="Indicator 1" width="50px" class="rounded-circle">
                            </div>
                            <div class="indicator-info ps-1 me-auto">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarginFive">
                          <button class="accordion-button collapsed bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMarginFive" aria-expanded="false" aria-controls="accordionMarginFive">
                            <div class="indicator">
                              <img src="https://positiivplus.com/public/uploads/sdg/1625656128_d4cd87957eaac066935d.png" alt="Indicator 1" width="50px" class="rounded-circle">
                            </div>
                            <div class="indicator-info ps-1 me-auto">
            ...
            <div class="col-xl-8 col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="balance-tab" data-bs-toggle="tab" href="#balance" aria-controls="balance" role="tab" aria-selected="true">Balance sheet</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="cash-tab" data-bs-toggle="tab" href="#cash" aria-controls="cash" role="tab" aria-selected="false">Cash Flow</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="ratio-tab" data-bs-toggle="tab" href="#ratio" aria-controls="ratio" role="tab" aria-selected="false">Ratio Analysis</a>
                    </li>
                  </ul>
                  <div class="tab-content">
                    <!-- balance tab -->
                      ...
                      <div class="card">
                        <div class="
                          ...
                          <div>
                            ...
                            <span class="card-subtitle text-muted">Operating Investment & Financing Activities</span>
                          </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="tab-pane" id="cash" aria-labelledby="cash-tab" role="tabpanel">
                      <div class="card">
                        <div class="
                                       ...
                                       ">
                          <div>
                            <h4 class="card-title">Cash Flow Statement : Comparision Graphs</h4>
                            <span class="card-subtitle text-muted">Operating Investment & Financing Activities</span>
                          </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="tab-pane" id="ratio" aria-labelledby="ratio-tab" role="tabpanel">
                      <div class="card">
                        ...
                        <div class="
                                          ...
                                          ">
                          <div>
                            <h4 class="card-title">Ratio Analysis : Comparision Graphs</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="table-container">
                    ...
                    <div class="note bg-light-success">
                      <p class="text-dark fw-bold p-1"><i class="fas fa-flag" style="color: red;"></i>Piotroski F-Score is a number between 0 - 9 which is used to assess strength of company's financial position. F-Score in the range of 8-9 is considered to be High Performer, range of 3-7 as Moderate Performer & 0-2 consider as Weak Performer.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="table-container">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h6 class="fw-bold">Beneish's M-Score (Profit Manipulation Test)</h6>
                          </td>
                          <td>
                            <p>-2.93</p>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h6 class="fw-bold">Altman Z-Score (Financial Distress Test)</h6>
                          </td>
                          <td>
                            <p>0.67</p>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h6 class="fw-bold">Montier's C-Score (Window Dressing Test)</h6>
                          </td>
                          <td>
                            <p>2</p>
                          </td>
                    ...
                    <!-- Add a note with flag icon -->
                    <div class="note bg-light-success">
                      <p class="text-dark fw-bold p-1"><i class="fas fa-flag" style="color: red;"></i>The Beneish model is a statistical model that uses financial ratios to check if it is likely (high probability) that the reported earnings of the company have been manipulated. If M-Score is less than -2.22 , the company is unlikely to be a manipulator and if the M-Score is greater than -2.22, then the company is likely to be a manipulator.</p>
                    </div>
                    <!-- Add a note with flag icon -->
                    <div class="note bg-light-success">
                      <p class="text-dark fw-bold p-1"><i class="fas fa-flag" style="color: red;"></i>The Altman Z Score is used to predict the chance of a business organization to move into bankruptcy.If the value is > 2.99, then there is no Financial distress, if the value is <= 2.00 and>= 1.23 then it is said to have Moderate Financial distress, and if the value is < 1.23 then it is said to have Higher Financial distress.</p>
                    </div>
                    <!-- Add a note with flag icon -->
                    <div class="note bg-light-success">
                      <p class="text-dark fw-bold p-1"><i class="fas fa-flag" style="color: red;"></i>Montier's C-Score is used to determine whether a company is cooking the books.If a company scores 0 there is no evidence of earnings manipulation whilst 6 suggests there is lots of evidence.</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="d-flex mb-2">
                      ...
                      <div class="blog-info">
                        <h6 class="blog-recent-post-title">
                          <a href="#" class="text-body-heading">Climate change: China's green power surge offers hope on warming</a>
                        </h6>
                        <div class="text-muted mb-0">A boom in wind and solar energy in China may curb emissions faster than expected, a report says.</div>
                      </div>
                    </div>
                    <div class="d-flex mb-2">
                      <a href="#" class="me-2">
                      ...
                      <div class="blog-info">
                        <h6 class="blog-recent-post-title">
                          <a href="#" class="text-body-heading">Driving Climate Solutions - Amazon Sustainability</a>
                        </h6>
                        <div class="text-muted mb-0">We aim to reach net-zero carbon emissions by 2040 by scaling solutions across our operations and collaborating with partners to broaden our impact.</div>
                      </div>
                    </div>
                    <div class="d-flex mb-2">
                      <a href="#" class="me-2">
                      ...
                      <div class="blog-info">
                        <h6 class="blog-recent-post-title">
                          <a href="#" class="text-body-heading">CO2 emissions from buildings and construction hit new high, leaving sector off track to decarbonize by 2050: UN</a>
                        </h6>
                        <div class="text-muted mb-0">In 2021, investments in building energy efficiency increased by 16% to USD 237 billion, but growth in floor space outpaced efficiency.</div>
                      </div>
                    </div>
                    <div class="d-flex">
                      <a href="#" class="me-2">
                        <img class="rounded" src="https://ichef.bbci.co.uk/news/976/cpsprodpb/17ED3/production/_129330089_gettyimages-1244873183.jpg.webp" width="100" height="70" alt="Recent Post Pic">
                      </a>
                      <div class="blog-info">
                        <h6 class="blog-recent-post-title">
                          <a href="#" class="text-body-heading">Climate change: Fossil fuel emissions from electricity set to fall - report</a>
                        </h6>
                        <div class="text-muted mb-0">Rise in wind and solar energy means that use of coal, oil and gas may have peaked for energy production.</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel1">View Product Details</h4>
            ...
            <div class="modal-body">
              <table class="table">
                <tbody>
                    ...
                    <td>
                      <div class="d-flex justify-content-start align-items-center product-name">
                        ...
                        <div class="d-flex flex-column">
                          <h6 id="p_name" class="text-body text-nowrap mb-0"></h6>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>category: </td>
                    <td><span class="text-truncate d-flex align-items-center"><span id="p_type"></span></span></td>
                  </tr>
                  <tr>
                    <td>Product Code: </td>
                    <td><span id="p_code"></span></td>
                  </tr>
                  <tr>
                    <td>Weight/Unit: </td>
                    <td><span id="p_weight"></span>&nbsp;<span id="p_unit"></span></td>
                  </tr>
                  <tr>
                    <td>Turnover Contribution: </td>
                    <td><span id="p_turn"></span>%</td>
                  </tr>
                  <tr>
                    <td>Product Life : </td>
                    <td><span id="p_life"></span>&nbsp;<span id="p_life_unit"></span></td>
                  </tr>
                </tbody>
              </table>
              <!-- </div> -->
              <div class="modal-footer">
                <button type="button" data-bs-dismiss="modal" class="btn btn-outline-secondary waves-effect">Hide</button>
              </div>
            </div>
          </div>
        </div>
        ...
        $(function() {
          ...
          var l = document.querySelector("#industry2"),
            d = {
              ...
              series: [{
                name: "Avg Percentage",
                data: [10.213333333333.toFixed(2), 11.806666666667.toFixed(2), 2.2933333333333.toFixed(2)]
              }],
              xaxis: {
                categories: ["Environment", "Governance", "Social"]
              },
      ...
      <script>
        var options = {
          ...
          colors: [
            ...
            '#ffd703', '#FF4500', '#f8f9f9', '#f8f9f9', '#8cc74e',
            '#61a140'
          ],
          legend: {
            show: false
