                                ...
                                <div class="accordion-body p-0">
                                    ...
                                    <div class="card_body_inn_2">
                                        ...
                                        <div class="admin_btn mt-2">
                                            <input type="button" class="btn btn-gradient-dark btn-sm" value="Submit" onclick="">
            ...
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <a href='<?= base_url('Controlwork/start_assessment'); ?>/<?= $id . '/' . $id; ?>' class='btn btn-primary float-end mx-2'>Back</a>
        ...
        <div class="content-body">
            ...
            <div class="category_page_header">
                <div class="cph_inner">
                    ...
                    <div class="cph_right">
                        <div class="cph_title"><?= $a_q[0]['indicator_name'] ?></div>
                        ...
                        <div class="cph_status">
                            <div class="cph_status_left d-flex">
                                ...
                                <div class="cph_score_content">
                                    <div class="cph_score_label">Question Completion</div><span style="" id="alertMsg"></span>
                            ...
                            <div class="cph_status_right d-flex">
                                ...
                                <div class="cph_score_content">
                                    <div class="cph_score_label">Utopiic : Compilation Level</div>
                                    <div class="cph_score_result fw-bolder"><span id="percentiles1">
                                            <?= number_format(($percentile), 2) ?></span> %</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="accordion accordion-margin" id="accordionMargin">
                    ...
                    <div class="accordion-item">
                        ...
                        <h2 class="accordion-header" id="headingMargin<?= $key; ?>">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordionMargin<?= $key; ?>" aria-expanded="false" aria-controls="accordionMargin<?= $key; ?>">
                                <?= $row['question_title'] ?>
                                <span id="check<?= $row['id'] ?>"><?= in_array($row['id'], $is_submit) ? '<i class="fa fa-check me-4"></i>' : '' ?></span>
                                <span class="ms-auto me-2" id="tooltip"><i class="fa-solid fa-circle-question"></i>
                                    <p class="tooltiptext">
                                        <?= $row['remark']; ?>
                                    </p>
                        ...
                        <div id="accordionMargin<?= $key; ?>" class="accordion-collapse collapse" aria-labelledby="headingMargin<?= $key; ?>" data-bs-parent="#accordionMargin">
                            <div class="accordion-body p-0">
                                ...
                                <form class='okoko' onsubmit="event.preventDefault();submit_done(this,<?= $row['id'] ?>);">
                                    <div class="q-detail">
                                        <?= implode(":<br>", array($row['question'])) ?>

                                        <?php if ($row['is_document_needed']) { ?>

                                            <span class="badge bg-danger rounded-circle float-end">0</span> <?php
                                                                                                        } ?>
                                    </div>
                                    <div class="card_body_inn_2">
                ...
                <!--  <?php
                        if ($mand_ans >= $mand) { ?>
                                                <div>
                                                    <button class='btn btn-primary mt-1 float-end'>Complete</button>
                                                </div>
                                                <?php } ?> -->
