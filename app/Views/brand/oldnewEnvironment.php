                              ...
                              <div class="cph_inner">
                                 ...
                                 <div class="cph_right">
                                    ...
                                    <div class="cph_status">
                                       ...
                                       <!--   <div class="cph_status_right d-flex ms-0">
                                          <div class="cph_score_icon me-1">
                                             <img src="https://user.positiivplus.io/public/brand/assets/app-assets/images/Image_logo.jpeg" style="width: 39px;">
                                          </div>
                                          <div class="cph_score_content" style="border-bottom: 3px solid #defe73;">
                                             <div class="cph_score_label">SDG's Involved:SDG7:Affordable and Clean Energy</div>
                                          </div>
                                          <div class="cph_score_icon ms-1">
                                             <img src="https://user.positiivplus.io/public/brand/assets/app-assets/images/eye.jpeg" style="width: 39px;">
                                          </div>
                                       </div> -->
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                       ...
                                       <div class="card-body">
                                          ...
                                          <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                             ...
                                             <li class="nav-item">
                                                <a
                                                   ...
                                                   aria-selected="true" onclick="disclosurereload()"
                                                >Disclosure</a
                                                >
                                             </li>
                                             <!-- <li class="nav-item">
                                                <a
                                                   ...
                                                   aria-selected="false" onclick="Kpis()"
                                                >KPIS</a
                                                >
                                             </li> -->
                                             <li class="nav-item">
                                                <a
                                                   ...
                                                   aria-selected="false" onclick="requestreload()"
                                                   >Request <span style="background: white; color: black; position: relative; left: 10pc;">
                                                   <?php if(!$request_count == '0'){ echo $request_count;} ?></span></a
                                                   >
                                                </li>
                                                <li class="nav-item">
                                                   <a class="nav-link"
                                                      ...
                                                      aria-selected="true"  onclick="Historyreload(<?php echo $Indicator_id; ?>)"
                                                   >History</a
                                                   >
                                                </li>
                                             </ul>
                                             ...
                                             <div class="tab-content pt-1">
                                                ...
                                                <div class="tab-pane" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
                                                   <section>
                                                      <div class="row">
                                                         <div class="col-md-6">
                                                            <form method="post" id="klpj"action="<?php echo base_url() ?>/Environment/environmentt/<?php echo $Indicator_id; ?>"
                                                               ...
                                                               <div class="row">
                                                                  ...
                                                                  <div class="col-md-5">
                                                                     ...
                                                                     <select class="form-control" onchange="standard(this);" name="id">
                                                                        ...
                                                                        <option value="<?php echo $standarad_id['id']; ?>" <?php if($filter_id == $standarad_id['id']){echo 'selected';} ?>><?php echo $standarad_id['standard_name']; ?>
                                                                        </option>
                                                                        <?php
                                                                        } ?>
                                                      ...
                                                      <div class="modal-dialog modal-dialog-centered modal-lg">
                                                         <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-dark">
                                                               <form method="post" id="myCompanyForm"
                                                                  action="<?php echo base_url() ?>/Environment/connect" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="row">
                                                                    ...
                                                                    <!--  <div class="col-md-6 text-start mb-1">
                                                                       ...
                                                                       <select  class="form-control" id="frequency_assign_connect" name="frequency" required onchange="resetValueconnect(value)">
                                                                    ...
                                                                    <!--  <div class="col-md-6 text-start mb-1">
                                                                        ...
                                                                        <select class="form-control form-control-sm js-example-basic-single testbox1" name="monthly_name[]" id="connect_month" multiple required onchange="connect_monthly(value);">
                                                                ...
                                                                <table class="table" id="mytable">
                                                                    <thead>
                                                                      ...
                                                                      <th style="width: 18.1719px;">Delete</th>
                                                                           ...
                                                                           <tbody>
                                                                        <?php $key=0; foreach($SensorData as $key=>$SensorValue){?>
                                                                           <tr>
                                                                           <td ><?php echo ++$key; ?></td>
                                                   ...
                                                   foreach ($disclosure_show as $key => $disclosure_showi) {
                                                      ...
                                                      <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                                                         <div class="accordion" id="accordionExample">
                                                            ...
                                                            <div class="accordion-item" id="t1">
                                                               ...
                                                               data-bs-target="#accordionOne<?= $disclosure_showi['id'];?>"
                                                               aria-expanded="false"
                                                               aria-controls="accordionOne<?= $disclosure_showi['id'];?>"
                                                               >
                                                               ...
                                                               <div id="accordionOne<?= $disclosure_showi['id'];?>"
                                                                     ...
                                                                     <div class="total_fuel bg-dark text-white">
                                                                        <div class="row">
                                                                           ...
                                                                           <div class="col-md-2 text-end">
                                                                              <button class="btn btn-primary btn-icon waves-effect waves-float waves-light rounded-circle"
                                                                              data-subDisclosure_id="<?= $sub_disclosure_showid['sub_disclosure_id']; ?>"
                                                                              data-Disclosure_id="<?= $disclosure_showi['id']; ?>"
                                                                              data-task_title="<?= $subdisclosure_showid['sub_disclosure']; ?>"
                                                                              onclick="AssginModal(this)"><i class="fa-solid fa-user-plus"></i>
                                                                              </button>
                                                                              ...
                                                                              data-Disclosure_id="<?= $disclosure_showi['id']; ?>"
                                                                              data-task_title="<?= $subdisclosure_showid['sub_disclosure']; ?>"
                                                                              onclick="ConnectModal(this)"><i class="fa-solid fa-link"></i>
                                                                              </button>
                                                                              <?php
                                                                              }?>
                                                                              <div class="modal-dialog modal-lg">
                                                                  ...
                                                                  <div class="mt-2 pb-1">
                                                                     <div class="row">
                                                                        ...
                                                                        ?>
                                                                        <?php if($key1 == $key2){ if($type_option_show == '1' || $type_option_show == '2'){ ?>
                                                                       ...
                                                                       ?>
                                                                        <div class="col-md-2">
                                                                           <label class="form-label fs-6" for="select2-basic"><?php if(str_word_count($option_answer_show['answer_name']) >2 ){echo substr_replace($option_answer_show['answer_name'], "...", 14);}else{echo $option_answer_show['answer_name'];} ?></label>
                                                                           ...
                                                                           <select  class="form-control  listing<?= $all_subdisclosure_id['id'].$all_subdisclosure_id['sub_disclosure_id']?>" id="energy_list<?= $option_answer_show['id']?>"
                                                                              name="list<?= $all_subdisclosure_id['id'].$option_answer_show['id']?>[]" readonly=""
                                                                              onchange="multipleselect(value)">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                           ...
                                                                           <input type="number" id="vertical-landmark" class="form-control total_number"
                                                                           data-id="<?php echo $all_subdisclosure_id['id']; ?>"
                                                                           data-idd="<?php echo $all_subdisclosure_id['id']; ?>"
                                                                           data-sub="<?php echo $all_subdisclosure_id['sub_disclosure_id']; ?>"
                                                                           onclick="Valueclick(this);"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                           ...
                                                                           <input type="number" id="vertical-landmark" class="form-control total_number"
                                                                           data-id="<?php echo $all_subdisclosure_id['id']; ?>"  onclick="Valueclick(this);"
                                                                        ...
                                                                        <input type="hidden" class="form-control total_number_add_more<?= $all_subdisclosure_id['id'];?>" value="<?= str_replace(' ', '', $swati);?>" placeholder="Joules" readonly="">
                                                                        ...
                                                                        <div class="container bg-light mt-3">
                                                                           ...
                                                                           <div class="row">
                                                                              ...
                                                                              $energy_data =
                                                                              $db->query("SELECT sum(em.value) as data FROM `energy_managment_data` as em WHERE status =1 and supplier_id = $u_id and data_id = $value_id")->getResultArray();
                                                                              ?>
                                                                              <div class="col-md-2" style="margin-top: 5px;">
                                                                                 <input type="number"class="form-control" id="totalvalue<?= $all_subdisclosure_id['id']; ?>" placeholder="Value"
                                                                                 value="<?= $energy_data[0]['data']; ?>" readonly="">
                                                                              </div>
                                                 ...
                                                 <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle"  style="display: none;" aria-hidden="true">
                                                                     <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                           ...
                                                                           <div class="modal-body text-dark">
                                                                              <form method="post"
                                                                                 action="<?php echo base_url() ?>/Environment/control_environment_submit" id="assignForm4" enctype="multipart/form-data">
                                                                                 <input type="hidden" name="indicator" value="17">
                                                   ...
                                                   <div class="modal-dialog sidebar-lg sidebar-extra-lg">
                                                      <div class="modal-content p-0">
                                                         ...
                                                         <ul class="nav nav-tabs mb-0" role="tablist">
                                                            <li class="nav-item">
                                                               <a class="nav-link-tabs active text-white btn waves-effect waves-float waves-light rounded-0 active" style="width:18rem;" id="home-tab"
                                                               data-bs-toggle="tab" href="#home_new" aria-controls="home"  role="tab" aria-selected="true">Record</a>
                                                            </li><li class="nav-item"><a class="nav-link-tabs text-white btn waves-effect waves-float waves-light rounded-0" style="width:17rem;"
                                                         id="profile-tab" data-bs-toggle="tab" href="#profile_new" aria-controls="profile" role="tab" aria-selected="false">Calculate</a></li>
                                                      </ul>
                                                            ...
                                                            <div class="tab-pane active" id="home_new" aria-labelledby="home-tab_1" role="tabpanel">
                                                               <form id="createFormSide"  method="post" action="<?= base_url("Environment/create") ?>" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="row mb-1" id="date_option" style="display:none;">
                                                                     ...
                                                                     <div class="col-md-2">
                                                                        <label for="exampleFormControlInput1" class="form-label">Monthly</label></div>
                                                                        <div class="col-md-4">
                                                                     ...
                                                                     <div class="tab-pane" id="profile_new" aria-labelledby="profile-tab_1" role="tabpanel">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                           ...
                                                                           <div class="pb-2">
                                                                              <select class="form-select calculation-Reset" aria-label="multiple select example"
                                                                                 onchange="unit(value)">
                                                                                 <option>select from list</option>
                                                                        ...
                                                                        <div class="row">
                                                                           ...
                                                                           <div class="col-md-6">
                                                                              ...
                                                                              <div class="pb-2">
                                                                                 <select class="form-select calculation-Reset" aria-label="multiple select example"
                                                                                    onchange="unitsubunit(value)" id="unit_id_data">
                                                                                    <option>select from list</option>
                                                                           ...
                                                                           <div class="col-md-6">
                                                                              <h6>Sub Unit:</h6>
                                                                              <div class="pb-2">
                                                                                 <select class="form-control  form-control-sm calculation-Reset select2 convertdata"
                                                                                    id="subUnitdata">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                              ...
                                                                              <div class="card">
                                                                                 <div class="card-body d-flex align-items-center justify-content-between">
                                                                                    <div>
                                                                                       ...
                                                                                       <?php  if(empty($fuel_dis[0]['data']))
                                                                                       {echo '0';}
                                                                                       else{ echo $fuel_dis[0]['data']; } ?> </h3>
                                                                                       <span>Joules</span>
                                                                                    </div>
                                                                           ...
                                                                           <div class="shadow">
                                                                              <div class="card">
                                                                                 <div class="card-body d-flex align-items-center justify-content-between">
                                                                                    <div>
                                                                                       <h3 class="fw-bolder mb-75"><?php echo $B; ?> </h3>
                                                                                       <span>Joules</span>
                                                                                    </div>
                                                                                    <div class="avatar bg-light-success p-50">
                                                                                       <span class="avatar-content">
                                                                           ...
                                                                           <div class="shadow">
                                                                              <div class="card">
                                                                                 <div class="card-body d-flex align-items-center justify-content-between">
                                                                                    <div>
                                                                                       <h3 class="fw-bolder mb-75"><?php echo $C; ?> </h3>
                                                                                       <span>Joules</span>
                                                                                    </div>
                                                                                    <div class="avatar bg-light-success p-50">
                                                                                       <span class="avatar-content">
                                                                           ...
                                                                           <div class="shadow">
                                                                              <div class="card">
                                                                                 <div class="card-header flex-column align-items-start pb-0">
                                                                                    ...
                                                                                    <h3 class="fw-bolder"><?php  $B_C = $B-$C;
                                                                                    echo $A+$B_C;
                                                                                    ?> Joules</h3>
                                                                                 </div>
                                                                        ...
                                                                        <div class="col-lg-2 col-md-6">
                                                                           <div class="card mb-0">
                                                                              <div class="card-body pb-50">
                                                                                 ...
                                                                                 <h4 class="fw-bolder mb-1"><?php  if(empty($energy_product[0]['data'])){echo '0';}else{ echo $energy_product[0]['data'];}?> Joules</h4>
                                                                              </div>
                                                                           </div>
                                                                        </div>
                                                                        <div class="col-lg-2 col-md-6">
                                                                           <div class="card mb-0">
                                                                              <div class="card-body pb-50">
                                                                                 ...
                                                                                 <h4 class="fw-bolder mb-1"><?php  if(empty($energy_services[0]['data'])){echo '0';}else{ echo $energy_services[0]['data'];}?> Joules</h4>
                                                                              </div>
                                                                           </div>
                                                                        </div>
                                                                        <div class="col-lg-2 col-md-6">
                                                                           <div class="card mb-0">
                                                                              <div class="card-body pb-50">
                                                                                 ...
                                                                                 <h4 class="fw-bolder mb-1"><?php  if($energy_sales[0]['data']==''){echo '0';}else{ echo $energy_sales[0]['data'];}?> Joules</h4>
                                                                              </div>
                                                                           </div>
                                                                        </div>
                                                                        <div class="col-lg-2 col-md-6">
                                                                           <div class="card mb-0">
                                                                              <div class="card-body pb-50">
                                                                                 ...
                                                                                 <h4 class="fw-bolder mb-1"><?php  if($energy_Employee[0]['data']==''){echo '0';}else{ echo $energy_Employee[0]['data'];}?> Joules</h4>
                                                                              </div>
                                                                           </div>
                                                                        </div>
                                                                        <div class="col-lg-2 col-md-6">
                                                                           <div class="card mb-0">
                                                                              <div class="card-body pb-50">
                                                                                 ...
                                                                                 <h4 class="fw-bolder mb-1"><?php  if($energy_size[0]['data']==''){echo '0';}else{ echo $energy_size[0]['data'];}?> Joules</h4>
                                                                              </div>
                                                                           </div>
                                                                        </div>
                                                                     </div>
                                          ...
                                          series: [{
                                          name: "Sold",
                                          data: [<?= $Electricity_sold ?>, <?= $Heating_sold ?>, <?= $Cooling_sold ?>, <?= $Stream_sold ?>]
                                          }, {
                                          name: "Consumed",
                                          data: [<?= $Electricity ?>, <?= $Heating ?>, <?= $Cooling ?>, <?= $Stream ?>]
                                          }],
                                          xaxis: {
                                          ...
                                          data: [<?php if($outside_Purchased[0]['data'] == ""){echo '';}else{ echo $outside_Purchased[0]['data'];} ?> ,
                                          <?php if($outside_Capital[0]['data'] == ""){echo '';}else{ echo $outside_Capital[0]['data'];} ?> ,
                                          <?php if($outside_Fuel[0]['data'] == ""){echo '';}else{ echo $outside_Fuel[0]['data'];} ?>,
                                          <?php if($outside_Upstream[0]['data'] == ""){echo '';}else{echo $outside_Upstream[0]['data'];} ?>,
                                          <?php if($outside_Waste[0]['data'] == ""){echo '';}else{ echo $outside_Waste[0]['data'];} ?>,
                                          <?php if($outside_Business[0]['data'] == ""){echo '';}else{ echo  $outside_Business[0]['data'];} ?>,
                                          <?php if($outside_Employees[0]['data'] == ""){echo '';}else{  echo $outside_Employees[0]['data'];} ?>,
                                          <?php if($outside_Leased[0]['data'] == ""){echo '';}else{  echo $outside_Leased[0]['data'];} ?>,
                                          <?php if($outside_Downstream[0]['data'] == ""){echo '';}else{ echo $outside_Downstream[0]['data'];} ?>,
                                          <?php if($outside_Processing[0]['data'] == ""){echo '';}else{ echo $outside_Processing[0]['data'];}
                                          ?>,
                                          <?php if($outside_sold[0]['data'] == ""){echo '';}else{ echo $outside_sold[0]['data'];} ?>,
                                          <?php if($outside_End_of_life[0]['data'] == ""){echo '';}else{echo $outside_End_of_life[0]['data'];} ?>,
                                          <?php if($outside_Downstreamleased[0]['data'] == ""){echo '';}else{ echo $outside_Downstreamleased[0]['data']; }?>,
                                          <?php if($outside_Franchises[0]['data'] == ""){echo '';}else{echo $outside_Franchises[0]['data'];} ?>,
                                          <?php if($outside_Investments[0]['data'] == ""){echo '';}else{ echo $outside_Investments[0]['data'];} ?>],
                                          borderWidth: 0
                                          }]
                                          }
                                          });
                                          ...
                                          {
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/subdisclosure_totalValue/"+sub_dis_id +"/"+id_value,
                                          method: "GET",
                                          success: function(data)
                                          {
                                          ...
                                          {
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/AllcreateRecord/"+idvname,
                                          method: "GET",
                                          success: function(data) {
                                          ...
                                          function Historyreload(that)
                                          {
                                            ...
                                            // alert(that);
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/historyreload/"+that,
                                          method: "GET",
                                          success: function(data) {
                                          ...
                                          {
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/requestreload",
                                          method: "GET",
                                          success: function(data) {
                                          ...
                                          <script>
                                          function showBoundary_sidebar(that) {
                                         ...
                                         $.ajax({
                                          ...
                                          var  task_name=$(that).attr("data-task_name");
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/environment_reminder/"+  id + '/' + owner + '/' + task_name,
                                          type: "POST",
                                          //dataType: "JSON",
                                          success: function(data){
                                          ...
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/subdisclosure_totalValue/"+SubDisclosure_id+"/"+idShow,
                                          method: "GET",
                                          success: function(data)
                                          {
                                          var total = data.success;
                                         ...
                                         if(value == 1){
                                          ...
                                          {
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/subdisclosure_totalValue/"+value+"/"+id,
                                          method: "GET",
                                          success: function(data)
                                          {
                                          var total = data.success;
