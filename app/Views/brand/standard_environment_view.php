                                 ...
                                 <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                       ...
                                       <div class="card-body">
                                                            ...
                                                            <div class="tab-pane active" id="home_new" aria-labelledby="home-tab_1" role="tabpanel">
                                                               <form id="createFormSide"  method="post" action="<?= base_url("Environment/create") ?>" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="row mb-1" id="date_option" style="display:none;">
                                                                     ...
                                                                     <div class="Guidance">
                                                                        ...
                                                                        <p><?php echo $subcla["guidelines"]; ?></p></div>
                                                                     </div>
                                                               ...
                                                               <div class="tab-pane" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
                                                                  <div class="">
                                                                     <!-- charts part 1 -->
                                                                     <form method="post"
                                                                      action="<?php echo base_url('Environment/Energy_graph/'.$Indicator_id)?>" enctype="multipart/form-data">
                                                                        <div class="row">
                                          ...
                                          var idg =  $('.dynamicdata3').val();
                                          // alert(id);
                                          var classdiv = document.getElementsByClassName("total_number_add_more"+idg)[0].value;
                                          // alert(classdiv);
                                          $.ajax({
                                          url : "<?php echo base_url()?>/Environment/dynamicRecord",
                                          method: "GET",
                                          success: function(data) {
                                          // alert(data);
                                          $("."+classdiv).html(data);
