...
<div class="app-content content">
 ...
 <div class="category_page_header">
            ...
            <!-- Role cards -->
            <div class="row mt-4">
               <?php  foreach ($social_indicator as  $value) { ?>
              
             
                                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card mb-4">
    <a href="<?php echo base_url().'/social_indicator_view/'.$value['id'];?>"
                            class="myblock1">
                            <div class="card-body">
                                <div class="cs_icon">
                                 <img src="<?= base_url("/")?>/public/uploads/sdg/<?php echo $value['image'] ?>">
                                                                    </div>
                                ...
                                <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                                    <div class="role-heading">
                                        <h4 class="fw-bolder text-uppercase font-size-17">
                                            <?php echo $value['indicator_name'] ?>                                        </h4>
                                       <!--  <span>
