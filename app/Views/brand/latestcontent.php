    ...
    <div class="page-content card-body card-datatable table-responsive pt-0">
                ...
                <div class="col-md-4">
                    <div class="card" style="height: 160px;">
                        <div class="card-body"><b>Location Address</b>
                            <hr>SCF 136, Market, Sector 14, Faridabad, Haryana 121007, India
                        </div>
                    </div><!-- pie chart -->
                    <div class="card" style="height: 160px;">
                        <div class="card-body">
                            <!-- <canvas id="myChart" height="219"></canvas> --><b>Classification</b>
                            <hr>Calculation,<br>Environmental,<br>Services,<br>Bussiness Services
                        </div>
                    </div>
                </div>
                <!-- end location  -->
        ...
        <ul class="nav nav-tabs x-scrolll" role="tablist">
            <div class="d-flex">
                <li class="nav-item me-3" onclick="add_active($(this))">
                    <a class="nav-link" id="" data-bs-toggle="tab" href="#" aria-controls="" role="tab" aria-selected="true">General</a>
                </li>
                <!-- <li class="nav-item me-3" onclick="add_active($(this))">
                    <a class="nav-link" id="" data-bs-toggle="tab" href="#" aria-controls="" role="tab" aria-selected="true">Ownership</a>
                </li>
                <li class="nav-item me-3" onclick="add_active($(this))">
                ...
                <li class="nav-item me-3" onclick="add_active($(this))">
                    <a class="nav-link active" id="finan-per" data-bs-toggle="tab" href="#finan-per1" aria-controls="finan-per1" role="tab" aria-selected="true">Financials</a>
                </li>
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="tab-content p-0">
                ...
                <div class="tab-pane active" id="finan-per1" aria-labelledby="finan-per" role="tabpanel">
                    <div class="row">
                        <!-- Basic Tabs starts -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active " style="margin-left: 13px;/* padding: 17px; */" id="balance-tab" data-bs-toggle="tab" href="#balance" aria-controls="balance" role="tab" aria-selected="true">Balance
                                                sheet</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div class="tab-pane" id="ratio" aria-labelledby="ratio-tab" role="tabpanel">
                                            <div class="mt-2 mb-1">
                                                <h5>Ratio Analysis : Comparision Graphs</h4>
                                                    <span class="card-subtitle text-muted">Return on Capital Employed
                                    ...
                                    <div class="table-responsive fixed-height-table" id="ratioTable" style="display: none;">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="fw-bold">Operating Cash Margin (OCF/Sales)
                                                            (%)
                                                        </h6>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="table-container">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="fw-bold">Overall Financials Strength Test</h6>
                                                    </td>
                                                    <td>
                                                        <p>5</p>
                                                    </td>
                                        ...
                                        <!-- Add a note with flag icon -->
                                        <div class="note bg-light-success">
                                            <p class="text-dark fw-bold p-1"><i class="fas fa-flag pe-1" style="color: red;padding-right: 3px;"></i>Piotroski F-Score is a
                                                number between 0 - 9 which is used to assess strength of company's
                                                financial position. F-Score in the range of 8-9 is considered to be High
                                                Performer, range of 3-7 as Moderate Performer & 0-2 consider as Weak
                                                Performer.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                            <h6 class="fw-bold pt-1">Other widely accepted Traditional Models</h6>
                                        </div>
                                        <div class="col-4">
                                            <!-- Add the select box for years here -->
                                            <div class="form-group mb-1">
                                    ...
                                    <div class="table-container">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h6 class="fw-bold">Beneish's M-Score (Profit Manipulation Test)
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <p>-2.93</p>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="fw-bold">Altman Z-Score (Financial Distress Test)
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <p>0.67</p>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="fw-bold">Montier's C-Score (Window Dressing Test)
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <p>2</p>
                                        ...
                                        <!-- Add a note with flag icon -->
                                        <div class="note bg-light-success">
                                            <p class="text-dark fw-bold p-1"><i class="fas fa-flag pe-1" style="color: red;padding-right: 3px;"></i>The Beneish model is a
                                                statistical model that uses financial ratios to check if it is likely
                                                (high probability) that the reported earnings of the company have been
                                                manipulated. If M-Score is less than -2.22 , the company is unlikely to
                                                be a manipulator and if the M-Score is greater than -2.22, then the
                                                company is likely to be a manipulator.</p>
                                        </div>
                                        <!-- Add a note with flag icon -->
                                        <div class="note bg-light-success">
                                            <p class="text-dark fw-bold p-1"><i class="fas fa-flag pe-1" style="color: red;"></i>The Altman Z Score is used to predict the
                                                chance of a business organization to move into bankruptcy.If the value
                                                is > 2.99, then there is no Financial distress, if the value is <= 2.00 and>= 1.23 then it is said to have Moderate Financial distress, and
                                                    if the value is < 1.23 then it is said to have Higher Financial distress.</p>
                                        </div>
                                        <!-- Add a note with flag icon -->
                                        <div class="note bg-light-success">
                                            <p class="text-dark fw-bold p-1"><i class="fas fa-flag pe-1" style="color: red;"></i>Montier's C-Score is used to determine
                                                whether a company is cooking the books.If a company scores 0 there is no
                                                evidence of earnings manipulation whilst 6 suggests there is lots of
                                                evidence.</p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">Climate change: China's green
                                                        power surge offers hope on warming</a>
                                                </h6>
                                                <div class="text-muted mb-0">A boom in wind and solar energy in China
                                                    may curb emissions faster than expected, a report says.</div>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <a href="#" class="me-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">Driving Climate Solutions -
                                                        Amazon Sustainability</a>
                                                </h6>
                                                <div class="text-muted mb-0">We aim to reach net-zero carbon emissions
                                                    by 2040 by scaling solutions across our operations and collaborating
                                                    with partners to broaden our impact.</div>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <a href="#" class="me-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">CO2 emissions from buildings
                                                        and construction hit new high, leaving sector off track to
                                                        decarbonize by 2050: UN</a>
                                                </h6>
                                                <div class="text-muted mb-0">In 2021, investments in building energy
                                                    efficiency increased by 16% to USD 237 billion, but growth in floor
                                                    space outpaced efficiency.</div>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <a href="#" class="me-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">Electricity charges revised in
                                                        Kerala, to go up by 6.6 per cent</a>
                                                </h6>
                                                <div class="text-muted mb-0">According to the revised slabs, those who
                                                    consume between 51 to 100 units in a month will have to bear an
                                                    additional Rs 22.50,.</div>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <a href="#" class="me-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">UK's Ofgem to raise energy
                                                        safeguard tariff level due to higher wholesale costs</a>
                                                </h6>
                                                <div class="text-muted mb-0">The safeguard tariff was introduced last
                                                    April and is designed to stop energy.</div>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <a href="#" class="me-2">
                                            ...
                                            <div class="blog-info">
                                                <h6 class="blog-recent-post-title">
                                                    <a href="#" class="text-body-heading">Climate change: Fossil fuel
                                                        emissions from electricity set to fall - report</a>
                                                </h6>
                                                <div class="text-muted mb-0">Rise in wind and solar energy means that
                                                    use of coal, oil and gas may have peaked for energy production.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>HRFB020050312022</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>MUKESH BHANOT</td>
                                                <td>Civil (C S)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SeCeQhSC2ij%2bfHxjsMW0DhgWyaf5xMHiUi%2fe6VtiBn8ssUy3Zml%2bOwIJVmFm6iJbbgzqE%2fT8EbD5P4%2fBrZvrmW6054YRI4%2bQv1dkri3iINh2CIvSmi5oPNpks67uGCMTdlAOzA6YMEwtycfeqWfdamWPHK2ct%2fLdM63OvPSNqsoQagaheybUUfA%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2022</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030588202022</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S A1 INDUSTRIAL SUPPLIERS</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEsByvw1MX5aMgh4PjGzvOL4HesApWQCqAozgTmSUTIUX%2bvQNh63UblYLvprTMvY%2bBbijscABEMNt2lJNkf7ioCP3LykeZNUU8%2bYipR%2bR3vXVGd9y%2bixdLZPGUaDluwsj6IUuVqsiLq6g%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2022</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030017232021</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>SRI SAI GANESH ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEsByvw1MX5aMgh4PjGzvOL4HesApWQCqAozgTmSUTIUX%2bvQNh63UblYLvprTMvY%2bBbijscABEMNt2lJNkf7ioCP3LykeZNUU8%2bYipR%2bR3vXVGd9y%2bixdLZPGUaDluwsj6IUuVqsiLq6g%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030017252021</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>R.A.ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEQ%2f0zxDph19HYL4mRWOJ9qv8ScGA9OiisfADVw5Ks4UrHG941hvPMSyHKBCQnecqWVBzMxZHAqv%2b1HW%2bwtn0rf0%2f8c35M8JrR3itjEhHpFF0ltOylYM00Dm6YnTCaxC4HMlFVLlmZLBw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030017242021</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>ADITYA ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGE6seqo1TAFFTeaWnCw4O82W3GVGGHxQsyMk71J8Q9%2bXnz4SwvAsVGdBukGsA63NY8hfBa9n9tRIkGld9rGEbJ3ByjWl2%2bcj3ydLECtI6Spz1WyY0VToZmiWVWt0GRDe7T7K9Ksn9vug%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB020017662021</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S BHAGWATI BEAUTY CENTRE</td>
                                                <td>Civil (C S)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SeCeQhSC2ij%2bfHxjsMW0DhgWyaf5xMHiUi%2fe6VtiBn8sbny5QLIYp%2fQhQkw14pYGS6Vt36xrly54WlsLYrIzXwtm7WNAdWtuzrepVNFLQkeB7qx0fws8w8w0Esw7UCa%2fy3PdOFWxyitkvTivohwifESZ49qzxouOKnsaHjwwbNd9BsmEyTvD5Pw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030167642021</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S PADMA ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbFm1Xo4q0Pm7K%2b2CZQOuQMBTiY08HlbVs0oC2uZCcxBVj4DGtqccK1hhvrUTZQd0I1qM1Ee5cfhJHmAVwzkVo9iDRsCBU9nm8wDlGcoAd1b3k8DxVB9QO6nUPi7N9%2bLZAn1rX1h%2bMk4Yg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030174782021</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>UNNATI ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbFeDanpObRigcEkP6rd3Mru2UmstqbgOxvo2E9f3G7ThdolLCWJMQBA1eCqoaBxRxBtGq%2f%2b84pximcrRiS%2bff8TKm3m%2fuRN65osmW8QIT8nFmlE99Jgiml6wm9a8IP17jVrVkb6RCERBg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030211002021</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S TEJAS TRADERS</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEZoBvJb6KVYV6fGIC9jHslOyHwl44bO2ozLJbX96qNM%2fclEkFXscSdantY%2bLi71Az8AK9FysJtO0PuAop4%2fTwPc58T61GyQoDRs0xwOe%2f5%2fOHCsb3eE%2bwq2CrYa4IrMT7xWF6YqfMR%2bg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2020</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030091032020</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S CHARU MARKETING AND CO</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGZ5HtHyqElfDbhvWmCY0w4nuVrHkWSSpHQoNoyUzmycVaD%2bejGOUAts%2ftDu%2fBtX%2fEaV4cLUFWx7ZtStqgtiQkgY1L740O6cwlJdC6RqRdy0HZFSZ9PoYZyBslFBFNzo6YwPHnhdzzIOA%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2020</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030183612019</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT.LTD.</td>
                                                <td>BEAUTY WORLD</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbG%2fELVa4DCy%2fK1x79m%2bmnH002W3H3zYNpoZUmXL2cI1Nyluuyxsu0TRw84vXLI8wJ54C%2baVvDnmhZq2IlONBesVQ0c802XHz%2ba4mO8COW0a9PreLzpRcTYRIdx0a2Kvh1IECULPK%2fUMqQ%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB020004982019</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>M/S NEEL MARKETING</td>
                                                <td>Civil (C S)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SeCeQhSC2ij%2bfHxjsMW0DhgWyaf5xMHiUi%2fe6VtiBn8tAn%2bTLCOcbHzQ3TaIPxiNs3flqkJNOBUCpBa3rapcTOeFpfkYrfMxA3ZcsiXwiZikFAXDiNEkDG7C7fSGY0lsiIBJeMatZ%2fLx4lIEcozXPOh3ykpS06%2b%2bA15AE5n7I9FrEX5FcWjBh2Q%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB020043292019</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS</td>
                                                <td>JAIN TRADERS</td>
                                                <td>Civil (C S)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SeCeQhSC2ij%2bfHxjsMW0DhgWyaf5xMHiUi%2fe6VtiBn8vbeTpJFD2ZxORw8%2f2kAXxfL5p509MhyfVgmLtOxRZTWspP%2b1ZiJ9nfgoUTjqZmnDwHwGlrVrCtjO1jGCUpvOT7CYwcL5LLdVV2wd6%2fxhWA3GN8n%2fF2W2SyqUvROtvc4OSC%2bE%2b1UGhTkw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030025522019</td>
                                                <td>District Court</td>
                                                <td>M/S OXYGLOW COSMETICS</td>
                                                <td>M/S SIDDHIR AGENCY</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbHxC4iT%2b%2b6PqBcQFrGMsRbz6aqQR3Of2CAcGIEx3FRF%2bmvLcxQXB04MY09lIqzFBuGXDolbnJfh%2fPBeTPtx2NNsLFabHBICfcgq2VUCJlsuBNNOfTP82%2bvH0RCECc479oHuqLERcKzHng%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030250572019</td>
                                                <td>District Court</td>
                                                <td>OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>NIMBLE COSMETIC WORLD</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbG6ipUqlfFJYjceJayAmFEX%2bUZnHWbN%2bJID0EhipRGnFv9JSJX49%2b5TmlNY1wN9l8ttc2Mzuv2%2fytEy%2b3NP6g64gYAhuTawe6noaOsZAWcwVgt6%2fUMzrY5yGfF4pXbGVjgc1ntc3X5Tvw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030259942019</td>
                                                <td>District Court</td>
                                                <td>OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>LAXMI FOOD AND BEVERAGE</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbHVO1X%2fH8z%2fgQu%2bEhFRikSIcCiD%2blDqqgRODyjpBeaHOu2mh9fe5CjPAESKOyLrDcoS8RyWg4%2fQALjMpm8JhY0pl%2bFBpO3U1T7jLj%2bVIQnWNaWXHP0%2fSmtiKZfKm8AqNMleWfWVrAvJmg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030071532019</td>
                                                <td>District Court</td>
                                                <td>OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>MAHA LAXMI SALES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEQ08HMMfV5x%2b5bSJa%2bZ7RZHPXnAsdGshdttfjKqd87iHNN%2fJ22GKr4c%2b8zjFsPT66cbwUWNkaNNRm87JewLc5SQei1hPspBBmdK%2bD9Ba4IFBsnFFOy90XyZxkYXUi%2bkNdLw5cx5U43Ig%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030071522019</td>
                                                <td>District Court</td>
                                                <td>OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>OK TRADERS</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbFxc9KV12pkuzx%2bKK51xCBQ6EAlCf3FYiDcdSHBBbMc%2bHYzt1cQQmRaj3FzzPhwNWXdIYKft46KRov9f3%2br9ln7dXRDFmN1crAOdiloyvynBEQiWWbfuOZfozU4zEQN2I1NlLWCewckFg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>PBPT020006412021</td>
                                                <td>District Court</td>
                                                <td>PAWAN KUMAR</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>Civil (EXE)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SaOyZeR3MSQ4daaQYtTMGsTdAIqIc1qE6PeX5xdN76SVTHtK31Go1L2h6P9dW1DJwu5Te2SuJSAAX6h541AmgfK%2fZhf9HfWagmSa3s1InvNNQ4kAEVwUjVHOSsdHSekcfGi8ySEGg%2bjxv%2fzN4v8vwLWKuljTCWiXSHpJxkHWJM59WTNQn6IRxBw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030034662020</td>
                                                <td>District Court</td>
                                                <td>OXYGLOW COSMETICS PVT.LTD.</td>
                                                <td>UTKARSH AGENCIES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbFLnBQmwRtmBhi4fHR33JtE7QchEDRvn0UuYJCQkOzA8pJyw%2f%2bkw42XzaemMVNZ9EK8BmTmxfPAcEOjVlu9POBecMttK6QaoVuYcWM2gFXDDB08Bjy5nfg2%2boJU6ZwEUXQMNElZ4BAIJg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2020</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030025512019</td>
                                                <td>District Court</td>
                                                <td>M/S OXY GLOW COSMETICS</td>
                                                <td>M/S HARI OM ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbFlSKUeswgdzKs85jPCQ0PzCTejkQotZ1%2fl8MyPikryE%2b4cJ7b7yv1d6J0NhXA8mTkJCamnz3OV2q4XSNyyHX99kOcJx0mBgqOmJY%2btJydKJJxZDDPGhVQ1DAjyx%2bwolRABSZnllsItwA%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2019</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030071512019</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>ROHIT ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGIZpjpx0Rw4Fsr%2bLguX7jQldQ5hXZwPK9LySUG0iICDaym5MR7JKttF9tJak3DVxQwcCJPenXZUCUePisSDRQ3uX2SXYWZ62%2fcsymd7KCqb0wUf25z93wDJRHhkRIhraQjogvIP9%2bIEw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2021</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030186252018</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>M/S BHAGYODAY ENTERPRISES</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGiqPcPJWLQ7UXpzO1MoizAdprzRbLAdJarniOoF0vB5jy3oCWtJebchT1wVcEim8h4zQoAkYrMVWeVXKJkk%2fZqgtFykIdGEW9Vd0w%2f2cAPdiAMDxT%2bGVRCFjcMJRmqDOsp8VpTmMwVEg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2018</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030352922018</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>M/S BEAUTY WORLD</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEJM9Tkun5PLyz9TOixitZNc%2bR14g92TeYQ%2fW7PvYrOXjyExtSQluGHdA14EV8I%2fj6iVIvpAroVVqVGMaFLw1GeM4s11qP4Lu3D1EuN6PKEgY003JfxeXuXXNzzGpUltxSGC9vfO08HiQ%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2018</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030356272018</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETICS PVT LTD</td>
                                                <td>PRAICH</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbG%2bjlRwZX4RK%2bqoqgVOeTZGuSC8MI%2f2aod8yi1jdM2VpWqa0WLp%2bUQaOoFbA9u27jalGt%2fxGxI8AoPZ05QITosPGEJi0%2bf%2bU4A19KUloFizQmp%2bsT3Nxe6eVhzLC297dxNNKWeiuW6NeA%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2018</td>
                                            </tr>
                                            <tr>
                                                <td>GJAH060135562018</td>
                                                <td>District Court</td>
                                                <td>RAKESHKUMAR AVANTILAL SHAH POA HOLDER OF BHARATIBEN R.SHAH
                                                    PROPRIETOR OF BHAGYODAY ENTERPRISE</td>
                                                <td>M/S.OXY GLOW COSMETICS PVT.LTD.</td>
                                                <td>Criminal (CR EN)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2STq7q3iYvnNEiPKv5d4CGh0ZkSl3lTqlLhtiW6pCPYsbEh%2bVOhdGNBXr2M6xAlk%2bjoFjnpRamrTxtyor%2bC2gfhEQYywHyScWn89GsV%2fzEDaC6jl9PSJB%2fpbtkuiWvHqLp7orRSnX6ccaHehdbowKuMqvV0hEhw6Xe3NofNp5XR7z9qjKPJF8csg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2018</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030240392017</td>
                                                <td>District Court</td>
                                                <td>MUKESH SINGHA</td>
                                                <td>OXY GLOW COSMETIC PVT LTD</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGFe3sxJIZJOuJDSzRigwR2WNs23eUEcGpd0LtQEVteTMrL3AN1Gt0hWtrAK%2buRj%2fssLZIbxhJ9INSjYjbjhDMCEnCoYGndgTyeqby3%2f5HzoqwU%2bnQthAMJbp9ujpRrOIeVsqDQrA%2fyGg%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2017</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030327422017</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETIC PVT LTD</td>
                                                <td>MUKESH SINGHA</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbGh5%2f4VknbZPRERZHFQcgKkA8hsAK3uTT9EDeUJRWWddZ0q9wkw6MnEfH3w5Jc9vAf0uedVJDXae9WCNo9uKbW%2bVmsIjOiQ1hge356RHSG5pa%2f7rO0V7bZJkVQDijCnSnPsO7B%2fKjEAXw%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2017</td>
                                            </tr>
                                            <tr>
                                                <td>HRFB030327392017</td>
                                                <td>District Court</td>
                                                <td>OXY GLOW COSMETIC PVT LTD</td>
                                                <td>MAHEE TRADERS</td>
                                                <td>Criminal (NACT)</td>
                                                <td><a href="https://www.instafinancials.com/legal-case-report.aspx?link=Qxh%2fBx65diwC82b1J4n%2fZZdLXPt1lA6e0KblzUGNxEaxxBo427wOfjkhF7HvDO2SywDxJOew7orBP5LqH0zGC3YbJeh3gYBLble3GXiNLbEqU7lVnLTWuKWJEWcGGqsTIRWFGFkgvmJZbatbKleJW5DmF9FnyX60vj3C4EJDjepJP3wSBfenmhVGtXwqOFD41iFCxgRF98EQz5upQgA%2bzdH%2bwMwHht8AaUxBEffJ2VCAxcusxsin8Q%3d%3d" class="text-dark fw-bolder">Click</a></td>
                                                <td>2017</td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <div class="row">
            ...
            <div class="app-logistics-fleet-sidebar col-md-5 h-100" id="app-logistics-fleet-sidebar">
                ...
                <div class="card-body p-2 pt-0 logistics-fleet-sidebar-body">
                    <!-- Menu Accordion -->
                    <div class="accordion" id="accordionExample" style=" width: 100%; height: 380px;overflow-y: auto; overflow-x: hidden;">
                        <!-- Fleet 1 -->
