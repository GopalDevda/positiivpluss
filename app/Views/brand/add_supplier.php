            ...
            <form class="form" method="post" action="<?php echo base_url() ?>/Suppliers_Model/createSupplier" enctype="multipart/form-data">
               <div class="row">
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        <label class="form-label" for="first-name-column">Supplier's Company Name</label><span>
                           <input type="text" placeholder="Enter Supplier's Company Name" name="company_name" required="" class="form-control">
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        ...
                        <input type="number" placeholder="Enter Supplier Code" name="supplier_code" class="form-control">
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        ...
                        <input type="text" class="form-control" name="supplier_address" id="" placeholder="Supplier Address" />
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-12">
                     ...
                     <select class="form-control select2" name="supplier_industry">
                        <option value="">Select Supplier Industry</option>
                        <?php if (isset($industary)) foreach ($industary as $t) {
                           if ($t['id'] == 0) continue;
                           echo '<option value="' . $t['id'] . '">' . $t['industry_name'] . '</option>';
                        } ?>
                     </select>
                  </div>
         ...
         <div class="modal-body">
            <form class="form" method="post" action="<?php echo base_url() ?>/Suppliers_Model/editSupplier" enctype="multipart/form-data">
               ...
               <div class="row">
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        <label class="form-label" for="first-name-column">Supplier's Company Name</label>
                        <input type="text" placeholder="Enter Supplier's Company Name" name="company_name" id="company_name" required="" class="form-control">
                     </div>
                  </div>
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                  ...
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        <label class="form-label" for="email-id-column">Supplier Industry</label>
                        <select class="form-control select2" name="supplier_industry" id="supplier_industry" required="">
                           <option value="">Select Supplier Industry</option>
                           <?php if (isset($industary)) foreach ($industary as $key => $t) {
                              if ($t['id'] == 0) continue;
                              echo '<option value="' . $t['id'] . '">' . $t['industry_name'] . '</option>';
                           } ?>
                        </select>
         ...
         <div class="row">
            ...
            <div class="col-md-3 pb-2">
               ...
               <select class="form-control" id="state">
                  <option value="">Select State</option>
                  <?php foreach ($supplier_state as $states) { ?>
            ...
            <div class="col-md-3 pb-2">
               ...
               <select class="form-control" id="industry">
                  ...
                  <?php foreach ($industary as $sta_idd) {
                     $run = 0;
                     foreach ($list as $sta) {
                        if ($run) break;
                        if ($sta['supplier_industry'] == $sta_idd['id']) {
                           echo '<option value="' . $sta_idd['industry_name'] . '">' . $sta_idd['industry_name'] . '</option>';
                           $run = 1;
                        }
                     }
                  } ?>
                     ...
                     <tbody>
                        ...
                        foreach ($list as $company) { ?>
                           <tr>
                              ...
                              <td><?php foreach ($industary as $v) {
                                       if ($v['id'] == $company['supplier_industry']) {
                                          echo $v['industry_name'];
                                       }
                                    }
                                    ?></td>
                              <td> <?php
                                    if (!$company['email'])
                                       ...
                                       echo '<span class="badge badge-light-success">Complete</span>';
                                    ?></td>
                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                       <a class="dropdown-item" href="#" data-toggle="modal" data-target="#docEditePopup" data-company_name="<?php echo $company['company_name']; ?>" data-name="<?php echo $company['name']; ?>" data-code="<?php echo $company['supplier_code']; ?>" data-type="<?php echo $company['supplier_type']; ?>" data-address="<?php echo $company['supplier_address'] ?>" data-country_id="<?php echo $company['country'] ?>" data-state="<?php echo $company['state'] ?>" data-supplier_industry="<?php echo $company['supplier_industry'] ?>" data-number="<?php echo $company['sup_id']; ?>" data-pincode="<?php echo $company['pincode']; ?>" data-email="<?php echo $company['sup_email']; ?>" onclick="editCompany(this)">
                                          <i data-feather="edit-2" class="me-50"></i>
                                          <span>Edit</span>
                                       </a>
                                       <a class="dropdown-item" href="#" data-toggle="modal" data-target="#docDeletePopup" data-number="<?php echo $company['sup_id']; ?>" onclick="deleteCompany(this)">
                                          <i data-feather="trash" class="me-50"></i>
                                          <span>Delete</span>
                                       </a>
                                       <?php if ($company['email']) {
                                          $id = $company['id'];  ?>
                                          <a class="dropdown-item" href="<?= base_url("/Suppliers_Model/supplier_view_profile/" . $id) ?>" data-toggle="modal" data-target="#docDeletePopup" data-number="<?php echo $company['sup_id']; ?>">
...
<script>
   ...
   function editCompany(that) {
      ...
      $("#supplier_industry").val(supplier_industry).change()
      $("#edit_email").val(email);
      $("#company_name").val(company_name);

      $('#docEditePopup').find('select').select2({
         dropdownParent: $("#docEditePopup")
      })
      $('#default').find('select').select2({
