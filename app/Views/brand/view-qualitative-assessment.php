                ...
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    <div class="modal-header bg-transparent">
                        <div class="bs-stepper-header p-0">
                            <h4 class="mt-1">Add Assessment</h4>
                            <!-- <div class="step me-1" data-target="#account-details-modern" role="tab" id="account-details-modern-trigger">
                                <button type="button" class="step-trigger wizard">
                                    <span class="bs-stepper-label m-0">
                                        <span class="bs-stepper-title">Assessment</span>
                                    </span>
                                </button>
                            </div> -->
                        </div>
                    ...
                    <div class="modal-body pb-1 px-sm-1 mx-50">
                        <div class="bs-stepper-content shadow-none p-0">
                            ...
                            <form class="form" method="post" action="<?php echo base_url() ?>/Qualitative_assessment/control_assessment_submit" enctype="multipart/form-data">
                                <div class="row">
...
<div class="modal fade text-start" id="docDeletePopup" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="<?php echo base_url() ?>/Qualitative_assessment/delete_assessment" method="post" enctype="multipart/form-data">
                    <div class="row">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Qualitative</h2>
                        ...
                        <div class="tab-content">
                                ...
                                <table class="table table-bordered example">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($control_assessment_pending as $key => $row) {
                                            ...
                                            $BrandQualitativeAnswerModel = new QualitativeSubmitAnswerModel();
                                            $resume_assessment = $BrandQualitativeAnswerModel->where('qualitative_assesment_id', $row['id'])->findAll();
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php
                                                    echo ++$key;
                                                    echo '<span class="badge rounded-pill badge-light-primary">' . $row['uniq_spl'] . '</span>'; ?>
                                                </td>

                                                <td><?= $row['assessment_name']; ?>
                                                </td>
                                                <td><?php
                                                ...
                                                <td>
                                                    ...
                                                    <div class="media">
                                                        <div class="media-aside align-self-center">
                                                            <a href="" class="b-avatar badge-light-info rounded-circle" target="_self" style="width: 32px; height: 32px;">
                                                                <span class="b-avatar-img">
                                                                    <?php if ($row['assigned_to_image']) { ?>
                                                                        <img src="<?= base_url("/") ?>/public/profilimg/<?= $row['assigned_to_image'];  ?>" alt="avatar">
                                                                    <?php } else { ?>
                                                                        <img src="<?= base_url("/") ?>/public/brand/assets/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar">
                                                                    <?php } ?></span>
                                                ...
                                                <td>
                                                    ...
                                                    $date1 = $row['start_date'];
                                                    $date2 = date("Y-m-d");
                                                    if (($start % 2 == 0 && $date1 <= $date2) || $row['num_show'] == 0) {
                                                    ?>
                                                        <?= $row['due_date'] ?>
                                                    <?php } else { ?>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <?php if ($row['assigned_to'] == session()->supplier_info['supplier_id']) {
                                                                if ($resume_assessment) { ?>
                                                                    <a class="dropdown-item" href="<?php echo base_url('assessment-question') ?>/<?= $row['id']; ?>/<?= $row['indicator']; ?>">
                                                            ...
                                                            <?php if ($row['supplier_id'] == session()->supplier_info['supplier_id']) { ?>
                            ...
                            <div class="tab-pane" id="profile1" aria-labelledby="profile-tab1" role="tabpanel">
                                <table class="table table-bordered example">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($control_assessment_complete) {
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <div><?= $row['completed_at']; ?>
                                                                <!-- <?php
                                                                        if ($row['frequency'] == 'Yearly') echo date('Y-m-d', strtotime($row['start_date'] . ' + 12 months'));
                                                                        elseif ($row['frequency'] == 'Half yearly') echo date('Y-m-d', strtotime($row['start_date'] . ' + 6 months'));
                                                                        elseif ($row['frequency'] == 'Monthly') echo date('Y-m-d', strtotime($row['start_date'] . ' + 1 months'));
                                                                        elseif ($row['frequency'] == 'Quarterly') echo date('Y-m-d', strtotime($row['start_date'] . ' + 4 months'));
                                                                        ?> -->
                                                            </div>
                                                        <?php
                                                        } ?>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                ?>
                                                                <a class="dropdown-item" href="<?php echo base_url('Qualitative_assessment/report_view') ?>/<?= $row['id']; ?>">
                                                                    <i class="fa solid fa-eye me-50"></i>
                                                                    <span>View Result</span>
                                                                </a>
...
<script type="text/javascript">
    ...
    function showBoundary(that) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>/Qualitative_assessment/getAssessment/" + boundary_id,
            type: "POST",
            //dataType: "JSON",
            success: function(data) {
                $("#indicator").html(data);
