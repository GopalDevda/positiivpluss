...
.nav-tabs .nav-item .nav-link.active {
    ...
    border-color: #262626 #262626 #fff;
    color: #fff;
}
...
<?php 
    ...
    if($total_product_footprint<1000) {
        ...
        echo ($total_product_footprint)." kgs CO2e";

    } 

    else {

        echo ($total_product_footprint/1000)." tonnes CO2e";
...
<input type="hidden" name="assessment_id" value="<?php echo $supp_assess?$supp_assess['id']:'0' ?>" />
        ...
        $supplier_info = $session->get('supplier_info');
         ...
         if($supplier_info) {
            ...
            <input type="hidden" name="ghg_id" value="<?php echo $industry_id; ?>" />
                                            ...
                                            <div class="step_field">
                                                ...
                                                <div class="theme_field step_three_column">
                                                    ...
                                                    <div class="stc_left">
                                                        ...
                                                        <input type="number" min="0"placeholder="Enter number" name="qty[]" value="<?php  echo $gad['quantity'] ?>">
...
?>          
                                                 ...
                                                 CO2e:	Estimate of building's footprint</span>
            ...
            <input type="hidden" id="mf_ghg_id" name="ghg_id" value="23" />
                                        ...
                                        <div class="row sfb">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                              <li class="nav-item">
                                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#process" role="tab" aria-controls="home" aria-selected="true">Process</a>
                                              </li>
                                              <li class="nav-item">
                                              ...
                                              <div class="tab-pane fade show active" id="process" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class="step_field" style="width:100%">
                                                    <div class="theme_field d-flex">
                                                        <select class="form-control" name="process_name[]">
                                                            <option value="0">Select Process</option>
                                                            <?php
                                                            if($manufacturing_process_detail) {
                                                            foreach($manufacturing_process_detail as $process) {
                                                            ?>
                                                            <option value="<?php echo $process['id']; ?>"><?php echo $process['process_id']; ?></option>
                                                            <?php
                                                            }
                                                            }
                                                            else {
                                                        ...
                                                        <select class="form-control" name="process_material_unit[]" style="width:105px;" id="process_material_unit">
                                                            <option value="0">Select Unit</option>
                                                            <?php
                                                            if($units) {
                                                        ...
                                                        <select class="form-control" id="process_raw_material" name="process_raw_material[0][]" multiple class="process_raw_material" style="border-radius: 0px">
                                                            <option value="0">
                                                                Raw Materialsss
                                                            </option>
                                                        </select>
...
<?php echo number_format($tot_manufacturing_footprint,2); ?>
                                                ...
                                                Kgs: Estimate of manufacturing's footprint
...
<!--                            <div class="alert alert-success custom_alert" role="alert">
    ...
    <?php 
        ...
        echo "for process ".$smp['process_name'];
...
?>
                                                ...
                                                CO2e : Estimate of manufacturing2's footprint
...
<!--         <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
              ...
              <select class="form-control" id="land_vehicle" onchange="find_emission_for_land_vehicle()">
...
<!--                                        <div class="step_inner">
                                            ...
                                            <div class="step_field">
                                                ...
                                                <div class="theme_field d-flex" id="raw_material">
...
?>
                                                ...
                                                </span> CO2e : Estimate of Transport Footprint
...
?>                                                                        
                                ...
                                <div class="cb_right">
                                    ...
                                    <div class="admin_btn" data-toggle="modal" data-target="#">
                                        ...
                                        <input type="button" value="Verify" onclick="verifyProductFootprint()">    
...
//      $('.factorDiv').append('<div class="step_inner append_row"><div class="theme_field step_label"><select class="form-control label_select" id="exampleFormControlSelect1" name="prod_factor[]">'+prod_factor+'</select></div><div class="step_field"><div class="theme_field step_three_column"><div class="stc_left"><input type="number" placeholder="Enter number" name="qty[]" value=""></div><div class="stc_center"></div><div class="stc_right"><select class="form-control" id="exampleFormControlSelect1" name="unit[]"><option></option></select></div></div></div><button class="close append_close" type="button" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="You can add more" onclick="addMoreFactor()"><span aria-hidden="true">+</span></button>&nbsp;<button class="remove_factor_block btn btn-danger"><i class="fa fa-trash"></i></button></div>');
    ...
    function verifyProductFootprint() {

      $.ajax({

            url : "<?php echo base_url()?>/brand/verifyProductFootprint",
