      ...
      <div class="content-header row">
         <div class="content-header-left col-md-6 col-12 mb-2">
            <div class="row breadcrumbs-top">
               <div class="col-12">
                  <h2 class="content-header-title float-start mb-0">View Template Question</h2>
            ...
            <div class="content-header-right text-md-end col-md-6 col-12 d-md-block">
               <div class="mb-1 breadcrumb-right">
                  <div class="dropdown">
                    ...
                    <a class="d-flex align-items-center" href="<?php echo base_url('taskscheduler/add_question');?>/1">
            ...
            <div class="card">
               <div class="card-body card-datatable table-responsive pt-0">
                  <table class="table table-bordered" id="example">
                     ...
                     <tbody>
                        <?php 
                           foreach($template_question as $key => $row){
                           ?>
                        <tr>
                           <td><?= ++$key;?></td>
                           ...
                           <td>
                              <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="<?= base_url('Taskscheduler/taskscheduler_delete')."/".$row['id'];?>" onclick="return confirm('Are you show delete this?');">
