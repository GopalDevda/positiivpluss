...
<?php 
    ...
    if($total_company_footprint<1000) {
        ...
        echo ($total_company_footprint)." kgs CO2e";

    }

    else {

        echo ($total_company_footprint/1000)." tonnes CO2e";
...
<!--                                         <div class="rounded-circle bg-secondary"><span><i class="material-icons">volunteer_activism</i></span></div> -->
                                        ...
                                        <div class="rounded-circle bg-secondary mr-0"><span><i class="material-icons">flight</i></span></div>

                                        <div class="rounded-circle bg-secondary mr-0"><span class=""><i class="material-icons">local_shipping</i></span></div>
...
</span> CO2e :   Estimate of building's footprint <span id="no_of_emp"></span>
                                    ...
                                    <div class="steps step_3">
                                        ...
                                        <div class="row sfb">
                                            ...
                                            <div class="col-sm-11 spt_right">
                                                ...
                                                <div class="form_big_title">Flight carbon footprint calculator</div>

                                                <div class="form_title_sub">

                                                    You can enter details for up to 5 flight itineraries
...
<!--                                        <div class="step_inner">                                            
                                            ...
                                            <div class="step_field">
                                                ...
                                                <div class="theme_field">
                                                    ...
                                                    <div class="q_radio_btn d-flex m-0">

                                                        <label class="radio radio-primary">

                                                            <input type="radio" name="trip_status" value="2" checked><span>Return trip</span><span class="checkmark"></span>

                                                        </label>&nbsp;&nbsp;&nbsp;

                                                        <label class="radio radio-primary">

                                                            <input type="radio" name="trip_status" value="1"><span>One-way flight</span><span class="checkmark"></span>
                                        ...
                                        <div class="step_inner">                                            
                                            ...
                                            <div class="step_label">
                                                ...
                                                <label for="inp1">From</label>

                                                <i class="fa fa-info-circle info_icon" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Departurs Destination"></i>
                                        ...
                                        <div class="step_inner">
                                            ...
                                            <div class="step_label">
                                                ...
                                                <label for="inp1">To</label>

                                                <i class="fa fa-info-circle info_icon" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Arrival Destination"></i>
                                        ...
                                        <div class="step_inner">                                            
                                            ...
                                            <div class="theme_field">                                                    
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="trip_class">
                                        ...
                                        <div class="step_inner">                                            
                                            ...
                                            <div class="step_label">
                                                ...
                                                <label for="inp1">Trips</label>

                                                <i class="fa fa-info-circle info_icon" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Number of flights taken of the same route"></i>
                                            ...
                                            <div class="theme_field">
                                                    ...
                                                    <input type="number" value="1" name="trip_count" id="trip_count">
...
?>                                                
                                                ...
                                                CO2e : Estimation of Flight Footprint
...
?>
    ...
    <?php 
        ...
        echo 'from '.$gd['trip_from'].' to '.$gd['trip_to'];
...
?>
    ...
    <?php 
        ...
        echo 'for mileage='.$gd['vehicle_mileage'];
...
?>
                                                 ...
                                                 CO2e : Estimate of mobile fuel's footprint</span>
