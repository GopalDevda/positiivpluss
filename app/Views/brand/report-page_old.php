    ...
    <div class="bs-stepper-content">
      ...
      >
        <div class="row">
          <div class="mb-1 col-md-3">
            <label class="form-label" for="vertical-username">Name</label>
            <input type="text" id="vertical-username" class="form-control" placeholder="" />
          </div>
          <div class="mb-1 col-md-3">
            <label class="form-label" for="vertical-email">Start Period</label>
            <input
              type="date"
              id="vertical-email"
              class="form-control"
          ...
          <div class="mb-1 col-md-3">
            <label class="form-label" for="vertical-email">End Period</label>
            <input
              type="date"
              id="vertical-email"
              class="form-control"
          ...
          <div class="mb-1 col-md-3">
            <label class="form-label" for="vertical-email">standard</label>
            <select class="form-control select2">
               <?php foreach($standard as $std){ 
                echo "<option>".$std['standard_name']."</option>"; }?>
              </select>
          </div>
        </div>
      ...
      <div id="step2" class="content" role="tabpanel" aria-labelledby="step2-trigger">
        <div class="content-header">
          <h4 class="mb-2">SELECT INDICATORS</h4>
          <p>
Following is a comprehensive list of globally recognised metrics encompassed in GRI, BRSR & CDP reporting standards a responsible organisation can access and include in their report. The indicator list is broad and concrete in nature, allowing the organization to choose and remove indicators as per their company profile and materiality awareness to reflect upon the organization's commitment  towards ESG indicators as well as showcase the same to various stakeholders.  </p>
        ...
        <div class="row">
          <div class="mb-1 col-md-12">
            <label class="form-label" for="vertical-first-name"> Indicators </label>
            <select placeholder="Select" class="select2 form-select" id="select2-multiple" multiple>
              <option value="">Select Indicators</option>
              <?php foreach($indicator as $indtor){ 
                echo "<option>".$indtor['indicator_name']."</option>"; }?>
            </select>
          </div>
        </div>
        <div class="d-flex justify-content-between">
      ...
      <div id="step3" class="content" role="tabpanel" aria-labelledby="step3-trigger">
        ...
        <div class="row">
              ...
              <div class="card-body">
                <div class="mb-1">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="customCheck1"> Disclosure 302-1Energy consumption within the organisation. </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck2" />
                    <label class="form-check-label" for="customCheck2"> Disclosure 302-2 Energy consumption outside of the organisation.</label>
                  </div>
                </div>
                ...
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck2" />
                    <label class="form-check-label" for="customCheck2"> Disclosure 302-3 Energy intensity.</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck2" />
                    <label class="form-check-label" for="customCheck2"> Disclosure 302-4 Reduction of energy consumption. </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck2" />
                    <label class="form-check-label" for="customCheck2"> Disclosure 302-5 Reductions in energy requirements of products and services.</label>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="mb-1">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="customCheck3">Disclosure 303-1 Interactions with water as a shared resource </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck4" />
                    <label class="form-check-label" for="customCheck4"> Disclosure 303-2 Management of water discharge-related impacts. </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck4" />
                    <label class="form-check-label" for="customCheck4"> Disclosure 303-3 Water withdrawal. </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck4" />
                    <label class="form-check-label" for="customCheck4"> Disclosure 303-4 Water discharge . </label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck4" />
                    <label class="form-check-label" for="customCheck4"> Disclosure 303-5 Water consumption. </label>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="mb-1">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="customCheck5"> Disclosure 3-1 Process to determine material topics .</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck6" />
                    <label class="form-check-label" for="customCheck6">  Disclosure 3-2 List of material topics .</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck6" />
                    <label class="form-check-label" for="customCheck6">  Disclosure 3-3 Management of material topics.</label>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Waste</h4>
              </div>
              <div class="card-body">
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck7" />
                    <label class="form-check-label" for="customCheck7">  Disclosure 306-1 Waste generation and significant waste-related impacts.</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck8" />
                    <label class="form-check-label" for="customCheck8">  Disclosure 306-2 Management of significant waste-related impacts.</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck7" />
                    <label class="form-check-label" for="customCheck7">  Disclosure 306-3 Waste generated .</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck8" />
                    <label class="form-check-label" for="customCheck8">  Disclosure 306-4 Waste diverted from disposal .</label>
                  </div>
                </div>
                <div class="mb-1">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="customCheck8" />
                    <label class="form-check-label" for="customCheck8"> Disclosure 306-5 Waste directed to disposal.</label>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div id="step4" class="content" role="tabpanel" aria-labelledby="step4-trigger">
        ...
        <div class="row mb-1">
          <h4 class="mb-1"><a href="#" class="dis">Energy</a></h4>
          <div class="ps-2">
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> DISCLOSURE 302-1 Energy Consumption within the organization. </a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 302-2 Energy consumption outside of the organisation.</a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 302-3 Energy intensity. </a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i>Disclosure 302-4 Reduction of energy consumption. </a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 302-5 Reductions in energy requirements of products and services. </a></h5>
            </div>
          </div>
        </div>
        <div class="row mb-1">
          <h4 class="mb-1"><a href="#" class="dis">Water</a></h4>
          <div class="ps-2">
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 303-1 Interactions with water as a shared resource. </a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 303-2 Management of water discharge-related impacts. </a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 303-3 Water withdrawala.</a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 303-4 Water discharge.</a></h5>
            </div>
            <div class="mb-1 col-md-12">
              <h5 class=""><a href="#" class="dis" tabindex="0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><i class="fa-solid fa-circle-check"></i> Disclosure 303-5 Water consumption.</a></h5>
            </div>
          </div>
        </div>
        <div class="d-flex justify-content-between">
...
<li>Sources of the coversion factors in use</li></ul>
