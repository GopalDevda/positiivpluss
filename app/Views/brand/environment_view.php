...
<div class="app-content content">
    <div class="category_page_header">
        <div class="cph_inner">
            ...
            <div class="cph_right">
                <div class="cph_title">Environment</div>
                 <?php if($indicator_category){ foreach($indicator_category as $val){?>
                <div class="cph_short_desc">
                   <?= $val['description'];?><?php echo ' Soon' ?>
                </div>
                <div class="cph_status">
                    ...
                    <div class="cph_status_left d-flex">
                        <div class="cph_score_icon me-1">
                            <img src="<?=base_url()?>/public/uploads/sdg/<?=$val['image']?>" style="width: 39px;">
                        </div>
    ...
    <!-- Role cards -->
    <div class="row mt-4">
        <?php foreach($environ_indicator as $vvvvvv){ ?>
      
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="card mb-4">
                <a href="<?php echo base_url().'/environment_indicator_view/'.$vvvvvv['id'];?>"
                    class="myblock1">
                    <div class="card-body">
                        <div class="cs_icon">
                        ...
                        <div class="d-flex justify-content-between mt-1">
                            <h6 class="fw-bolder">Environment</h6>
        ...
        <!--    src="https://user.positiivplus.io/public/uploads/sdg/1625734535_aad7df85b1aced993312.png"  -->                              <!-- <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card mb-4">
