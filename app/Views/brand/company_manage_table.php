            ...
            <form class="form" method="post" action="<?php echo base_url() ?>/brand/createCompany" enctype="multipart/form-data">
               <div class="row">
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                        <label class="form-label" for="first-name-column">Site Name</label><span id="nameError" style="color: red;" class="px-2"></span>
                        <input type="text" placeholder="Enter Site Name" name="company_name" id="companyForm" required="" class="form-control">
                     </div>
                  </div>
                  <div class="col-md-6 col-12">
                     <div class="mb-1">
                     ...
                     <div class="mb-1">
                        ...
                        <div class="demo-inline-spacing">
                           <div class="form-check form-check-inline mt-1">
                              <input class="form-check-input" type="radio" name="lease_owned" id="inlineRadio1" value="Lease" />
                              <label class="form-check-label" for="inlineRadio1">Lease</label>
                           </div>
                           <div class="form-check form-check-inline mt-1">
                              <input class="form-check-input" type="radio" name="lease_owned" id="inlineRadio2" value="Owned" />
            ...
            <div class="modal-body">
               <form class="form" action="<?php echo base_url() ?>/brand/importCsvToDb" method="post" enctype="multipart/form-data">
                  ...
                  <div class="modal-footer p-0 pt-1">
                     ...
                     <a href="https://positiivplus.io/public/sample-Template/Sample template.csv" classdownload="Template"><button type="button" class="btn btn-primary waves-effect"><i class="fa fa-download"></i> Csv Template </button></a>
...
<script>
   $(document).ready(function() {
      $('#companyForm').on('keyup', function() {
         var companyName = $(this).val();
         $.ajax({
            url: '<?php echo base_url() ?>/brand/checkCompanyExists',
            type: 'post',
            data: {
            ...
            success: function(response) {
               if (response.exists) {
                  // Show error message
                  $('#nameError').text("Company name already exists.");
