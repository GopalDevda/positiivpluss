...
<div class="card-body">
    ...
    <thead><tr><th>#</th><th>Groop Name</th><th>View Country</th><th>Country</th><th>Edit Group Name</th></tr></thead>

    <?php $s=1;

    foreach($ghg_factor as $d){
if(!empty($d['group_id']))
{?>
      <tr><td><?php echo $s;?></td>
      <td><?php echo $d['group_id'];?></td>

        <td><a class="btn btn-primary" href="javascript:void(0);" button onclick="getcountry('<?php echo $d['id']; ?>','<?php echo $d['name']; ?>')"  
       data-name='<?php echo $d['impact'];?>' data-number='<?php echo $d['id'];?>'><?php  echo "View Country"; ?></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <form method="post" name="sdg-form" id="sdf-form" action="<?php echo base_url();?>/master/edit_group_id" enctype='multipart/form-data'>
