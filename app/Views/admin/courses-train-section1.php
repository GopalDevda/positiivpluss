...
<?php } ?>
    ...
    <p class="card-text" id="output"></p>
                        <div class="card-body">
                                                       ...
                                                       <h1 contentEditable="true"><input 
                                                                    ...
                                                                    style=" background-color: white; 
                                                                            ...
                                                                            opacity: .1; 
                                                                           "
                                                                    type="text" value="Title" name="contenttitle1"></h1>
                                                                    <div contentEditable="true"><textarea  
                                                                    style=" background-color: white; 
                                                                            width: 20rem;
                                                                            border-top-style: hidden;
                                                                            ...
                                                                            background-color: #eee;
                                                                            opacity: .1; "
                                                                            value="You Favorite Movie" name="contentdiscription1"></textarea></div>   
                                                                    ...
                                                                    style=" background-color: white; 
                                                                            ...
                                                                            opacity: .1; 
                                                                           "
                                                                    type="text" value="Title" name="contenttitle2">
                                                                    ...
                                                                    style=" background-color: white; 
                                                                            ...
                                                                            background-color: #eee;
                                                                            opacity: .1; "
                                                                            value="You Favorite Movie" name="contentdiscription2"></textarea></div>
                                                                   <!--ending end-->
                                                              </div>
                    ...
                    <!--<div class="col-md-6 form-group" style="display:none;" id="showcontent">-->
                    ...
                    <!--<textarea  placeholder="content Here" id="inText"name="content" style="width: 100%;" ></textarea> -->
                    <!-- </div>-->
                ...
                <input type="file"  class="form-control"    name="audio">
                     ...
                     <div class="col-md-3 form-group" style="display:none;" id="showquiz"> 
