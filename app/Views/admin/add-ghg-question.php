...
<?php } ?>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Ghg Question </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form name="frm-ghg-question" id="ghg-question" method="post" action="<?php echo base_url();?>/master/addGhgQuestionSubmit">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="indicator_id" id="indicator_id" required="required" class="form-control">
                        ...
                        <option value="<?php echo $r['id'];?>"><?php echo $r['indicator_name'];?></option>
                       <?php  }
                        }?>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="footprint_id" id="footprint_id" required="required" class="form-control" onchange="getGhgAjax(this.value);">
                        ...
                        <option value="<?php echo $r['id'];?>"><?php echo $r['footprint_name'];?></option>
                       <?php  }
                        }?>
                    </select>
                  </div>
      ...
      <div class="form-group">
        ...
        <input type="text"  class="form-control" id="exampleInputEmail1" required="required" name="remark">
      </div>
