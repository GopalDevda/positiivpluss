      ...
      <div class="row mb-2">
        ...
        <!-- /.col -->
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo base_url();?>/assessment/proassessmentQuestion " class='btn btn-primary'><i class="fa fa-plus"></i> Add Pro Assessment Question </a> </li>
...
if($session->get('error')){?> <div class="alert alert-danger alert-dismissible">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Pro Questions List</h3>
            </div> <?php 
    ...
    foreach($list as $d){?> <tr>
                ...
                <td>
                  <a class="btn btn-primary" href="#" onclick="show_standards('<?php echo $d['assessment_id'] ?>')" data-id='<?php echo $d['assessment_id'] ?>' data-name='' data-number=''><i class="fa fa-eye"></i>
                  </a>
                </td>
          ...
          ?> </td>
                <td>
                  <a class="btn btn-primary" href="
                    <?php echo base_url()?>/assessment/editProAssessmentQuestion/<?php echo $d['assessment_id'];?>" onclick="" data-name='' data-number=''>
                    <i class="fa fa-pencil"></i>
                  </a>
                  <a class="btn btn-danger" href="
                    <?php echo base_url()?>/assessment/deleteProAssessmentQuestion/<?php echo $d['assessment_id'];?>" onclick="return confirm('Do you want to delete?');">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" name="sdg-form" id="sdf-form" action="
        <?php echo base_url();?>/assessment/editProAnswer">
...
<div class="modal fade" id="modal-standard-edit">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" name="sdg-form" id="sdf-form" action="
              <?php echo base_url();?>/assessment/editProStandard">
...
<script type="text/javascript">
  ...
  function show_answers(id) {
    $.ajax({
      url: "<?php echo base_url()?>/assessment/getproAnswers/"+id,
      type: "POST",
      //dataType: "JSON",
  ...
  function show_standards(id) {
    $.ajax({
      url: "<?php echo base_url()?>/assessment/getProStandards/"+id,
      type: "POST",
      //dataType: "JSON",
      success: function(data) {
