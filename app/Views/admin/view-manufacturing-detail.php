      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">Manufacturing Detail Management</h1>
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#" onclick="addManufacturingDetail()" class='btn btn-primary'><i class="fa fa-plus"></i> Add Manufacturing Detail</a> </li>
         ...
         <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Manufacturing Details List</h3>
    ...
    ?>
      ...
      <tr>
        ...
        <td>
          ...
          <a class="btn btn-primary" href="javascript:void(0);" onclick="editManufacturingDetail(this)" data-industry='<?php echo $d['industry_id'];?>' data-id='<?php echo $d['id'];?>' data-ghg='<?php echo $d['ghg_id']; ?>' data-process='<?php echo $d['process_id']; ?>' data-factor='<?php echo $d['ghg_factor_id']; ?>' data-per_quantity_val='<?php echo $d['per_quantity_val']; ?>' data-per_quantity_amt='<?php echo $d['per_quantity_amt']; ?>' data-unit='<?php echo $d['unit_id']; ?>' ><i class="fa fa-pencil"></i></a>

          <a class="btn btn-danger" href="<?php echo base_url()?>/master/deleteManufacturingDetail/<?php echo $d['id'];?>" onclick="return confirm('Do you want to delete?');"><i class="fa fa-trash"></i></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <form method="post" name="manufacturing-detail-form" id="manufacturing-detail-form" action="<?php echo base_url();?>/master/editManufacturingDetail">

              <input type="hidden" name="id" id="manufacturing_detail_id" value="" required="required">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Update Manufacturing Details</h3>
...
<?php 
  ...
  if($manufacturing_process) {
    ...
    foreach($manufacturing_process as $process) {
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <label for="industry">Select Input Output</label>

                    <select id="industry" name="inputOutput" required="required" class="form-control">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <form method="post" name="manufacturing-detail-add-form" id="manufacturing-detail-add-form" action="<?php echo base_url();?>/master/addManufacturingDetail">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Add Manufacturing Details</h3>
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" required="required" name="industry" id="industry_id" onChange="getGhgFactor('industry_id','ghg_id','ghg_factor_id','process_id','ghg_processradio_id')">
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" required="required" name="ghg" id="ghg_id" onChange="getGhgFactor('industry_id','ghg_id','ghg_factor_id','process_id','ghg_processradio_id')">
...
?>
             ...
             <div class="form-group">
                ...
                <input type="radio" class="ghg_link" onclick="rohit(this)"  name="per_quantity_amt" />
                  <label for="exampleInputEmail1" class="px-3"> Process</label>

                <input type="radio" class="ghg_link" onclick="proce(this)"  name="per_quantity_amt" />

                  </div>

                  <div class="form-group" style="display:none;" id="ghg_factor_show">

                    <label for="exampleInputEmail1">Select Ghg Factor</label>

                    <select class="form-control"  name="ghg_factor" id="ghg_factor_id">

                      <option value="NULL">Select Ghg Factor</option>

                    </select>

                  </div>
                  <div class="form-group" style="display:none;" id="process_show">

                    <label for="exampleInputEmail1">Select Process</label>

          <select class="form-control"  name="ghg_processradio" id="ghg_processradio_id">
...
$('#ghg_factor_show').hide();
$('#process_show').show();


}

   function editManufacturingDetail(that) {
        ...
        $('#manufacturing_detail_id').val(id);
    ...
    function addManufacturingDetail() {
  ...
  function getGhgFactor(industry_ref,ghg_ref,ghg_factor_ref,ghg_process_ref,ghg_processradio_ref) {
    ...
    if(industry_id && ghg_id) {
     ...
     if(industry_id) {
       ...
       var  ref_url_process = '<?php echo base_url(); ?>'+'/master/getProcess/'+industry_id;
