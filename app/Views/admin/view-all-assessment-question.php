...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?>/assessment/allassessmentQuestion/<?php echo $title; ?>" class='btn btn-primary'><i class="fa fa-plus"></i> Add <?php echo $heading; ?> </a> </li>
 ...
 -->
                ...
                <td> <?php echo $d['indicator_name']; ?> </td> -->
                    ...
                    <?php echo base_url() ?>/assessment/editAllAssessmentQuestion/<?php echo $d['assessment_id']; ?>" onclick="" data-name='' data-number=''>
                    ...
                    <?php echo base_url() ?>/assessment/deleteAllAssessmentQuestion/<?php echo $d['assessment_id']; ?>/<?php echo $title; ?>" onclick="return confirm('Do you want to delete?');">
...
<script type="text/javascript">
  ...
  function show_answers(id) {
    ...
    $.ajax({
      ...
      url: "<?php echo base_url() ?>/assessment/getallAnswers/" + id,
