      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo base_url();?>/assessment/assessmentQuestion" class='btn btn-primary'><i class="fa fa-plus"></i> Add Assessment Question </a> </li>
          ...
          ?> </td>
                <td>
                  <a class="btn btn-primary" href="
                    <?php echo base_url()?>/assessment/editAssessmentQuestion/<?php echo $d['assessment_id'];?>" onclick="" data-name='' data-number=''>
                    <i class="fa fa-pencil"></i>
                  </a>
                  <a class="btn btn-danger" href="
                    <?php echo base_url()?>/assessment/deleteAssessmentQuestion/<?php echo $d['assessment_id'];?>" onclick="return confirm('Do you want to delete?');">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" name="sdg-form" id="sdf-form" action="
        <?php echo base_url();?>/assessment/editAnswer">
