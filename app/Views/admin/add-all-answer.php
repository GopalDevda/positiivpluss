...
<?php } ?>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form name="frm-industry" id="industry" method="post" action="<?php echo base_url();?>/assessment/addAllAssessmentmasteranswer">
      ...
      <div class="form-group"  id="showoption" style="display:none">
        ...
        <input type="radio" id="yes" name="answeroption" value="1">
        ...
        <input type="radio" id="no" name="answeroption" value="2" checked="checked">
...
<!--End here-->
 ...
 <div class="col-md-5"  id="singleTypeAnswer" style="float: left;">
    <label for="exampleInputEmail1">Answer </label>
    <select name="singleanswer" id="singleanswer" required="required" class="form-control" >
      <?php 
        $degree_opt = "";
        if(!empty($singleanswer)) {
          foreach($singleanswer as $sans) {
            $degree_opt.='<option value="'.$sans['answerType'].'">'.$sans['answerType'].'</option>';
          }
        }
         echo $degree_opt;
      ?>
...
<div class="form-group">
  ...
  <div class="col-md-5" id="multitypeanser"style="float: left;display:none;">
  ...
  <div class="col-md-2" id="showPlus"style="float: left;display:none;">
    <label for="exampleInputEmail1" style="width: 100%;">&nbsp;</label>
