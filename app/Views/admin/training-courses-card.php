      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">Card Management</h1>
...
<?php } ?>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Add New Card to Courses </h3>
              ...
              <form name="from" id="form" method="post" action="<?php echo base_url();?>/trainingCourses/addCourseName">
                ...
                <div class="card-body">
                    ...
                    <label for="exampleInputEmail1">Training Module Course Name</label>
                      <select class="form-control" name="module_name" id="module_name">
                          <?php  if($coursemodulelist){
                          ?>     
                        <option value="0">Select Training Module Course Name </option>
                            <?php  foreach($coursemodulelist as $key=>$ind) {?>
                            <option value="<?php echo $ind['id']; ?>"> <?php echo $ind['modulename']; ?></option>
                            <?php } } ?>
                        </select>
                    </div>
                                  ...
                                  <div class="form-group">
                    <label for="exampleInputEmail1">Type of card</label>
                      <select class="form-control" name="card_id"  id="card_id" onchange="showcardtype(this);" >
                    ...
                    <!--old content start-->
                     ...
                     <div class="card card-css" id="showcontent">
                         <div class="form-group col-md-12">
							<label for="icon_facilities" class="text-center">Course Description</label>
                     ...
                     <div class="col-md-3 form-group" style="display:none;" id="showimage"> 
                    <label for="exampleInputEmail1">image</label>
                <input type="file"  class="form-control"    name="file">
                     </div>
                     
                     <div class="col-md-3 form-group" style="display:none;" id="showaudio"> 
                    <label for="exampleInputEmail1">Audio File</label>
                <input type="file"  class="form-control"    name="audio">
                     </div>
                     
                     <div class="col-md-8 form-group" style="display:none;" id="showquiz"> 
        ...
        <input type="text"  class="form-control" id="exampleInputEmail1" required="required" name="question_title">
                     ...
                     <div style="display:none;" id="showall">
                                    ...
                                    <textarea  placeholder="content Here" name="content" style="width: 100%;" ></textarea> 
                                     </div>
                                    ...
                                    <label for="exampleInputEmail1">Audio File</label>
                                     <input type="file"  class="form-control"    name="audio">
                                         ...
                                         <div class="col-md-3 form-group" > 
                                        <label for="exampleInputEmail1">Quiz Question</label>
                                    <input type="text"  class="form-control"    name="quiz"><i class="plus"></i>
                                         </div>
                    </div>
   ...
   <div class="col-md-6">
    ...
    <thead>
    <tr><th>#</th><th>Courses Module Name</th><th>Action</th></tr>
    </thead>
    <?php $s=1;

    foreach($coursemodulelist as $d){?>

      <tr><td><?php echo $s;?></td><td><?php echo $d['modulename'];?></td>

           <td>
  
  <a class="btn btn-primary" href="javascript:void(0);" onclick="viewFunction(this);" data-number='<?php echo $d['id'];?>' ><i class="fa fa-eye"></i></a>
