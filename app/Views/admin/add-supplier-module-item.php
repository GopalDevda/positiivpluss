          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Supplier Module Item </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form name="supplier-module-item" id="supplier_module_item" method="post" action="<?php echo base_url();?>/SupplierModule/addSupplierModuleItemSubmit" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select name="supplier_module_id" id="supplier_module_id" required="required" class="form-control">
                        ...
                        ?>
                          <option value="<?php echo $mod["id"] ?>"><?php echo $mod["supplier_module_name"] ?></option>
                        <?php 
                            }
                          }
                        ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="icon" required="required" name="icon">
