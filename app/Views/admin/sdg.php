      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">SDGs Management</h1>
          ...
          <div class="col-md-5">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Add New SDG</h3>
...
<input type="hidden" name="id" id="sdg_id1" value="" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required="required" class="form-control" id="exampleInputEmail1" placeholder="Enter SDG Name" name="sdg_name" >
     ...
     <div class="col-md-7">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">SDGs List</h3>
...
<div class="card-body">
   ...
   // print_r($sdg);
    ...
    <thead><tr><th>#</th><th>Name</th><th>Icon</th><th>Action</th></tr></thead>

    <?php $s=1;

    foreach($sdg as $d){?>

      <tr><td><?php $s;?></td><td><?php echo $d['sdg_name'];?></td>

        <td><img src="<?php echo base_url();?>/public/uploads/sdg/<?php echo $d['image'];?>" style="width: 100px;"></td>

        <td>

          <a class="btn btn-primary" href="javascript:void(0);" onclick="editSdg(this);" data-name='<?php echo $d['sdg_name'];?>' data-number='<?php echo $d['id'];?>' data-img='<?php echo base_url();?>/public/uploads/sdg/<?php echo $d['image'];?>'><i class="fa fa-pencil"></i></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <form method="post" name="sdg-form" id="sdf-form" action="<?php echo base_url();?>/master/editSdg" enctype='multipart/form-data'>
