          ...
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              ...
              <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="title" required="required" name="title" value="<?php echo $cms[0]['title'];?>">

                  </div>
              
              <div class="mb-3">
                    <label for="exampleInputEmail1">Content of the Page*</label>
                <textarea class="textarea" placeholder="Privacy-Policy" name="description" 
