      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">Rawmaterial Process Detail</h1>
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#" onclick="addRawmaterialProcessDetail()" class='btn btn-primary'><i class="fa fa-plus"></i> Add Rawmaterial Process Detail</a> </li>
...
<?php } ?>
         ...
         <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Rawmaterial Process Details List</h3>
    ...
    ?>
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-primary" href="javascript:void(0);" onclick="editRawmaterialProcessDetail(this)" data-subindustryyl='<?php echo $d['sub_industry_name'];?>' data-id='<?php echo $d['mpdid'];?>' data-name='<?php echo $d['process_name']; ?>' data-industry-id='<?php echo $d['industry_id'] ?>' data-unit-id='<?php echo $d['unit_id'] ?>'data-remark='<?php echo $d['remark'] ?>'><i class="fa fa-pencil"></i></a>
          <a class="btn btn-danger" href="<?php echo base_url()?>/master/deleteRawmaterialProcessDetail/<?php echo $d['mpdid'];?>" onclick="return confirm('Do you want to delete?');"><i class="fa fa-trash"></i></a>
        </td>
      </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form method="post" name="Rawmaterial-process-detail-form" id="hotel-stay-form" action="<?php echo base_url();?>/master/editRawmaterialProcessDetail">
              <input type="hidden" name="id" id="process_id" value="" required="required">
            <div class="modal-body">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Rawmaterial Process Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form method="post" name="Rawmaterial-process-detail-add-form" id="Rawmaterial-process-detail-add-form" action="<?php echo base_url();?>/master/addRawmaterialProcessDetail">
            <div class="modal-body">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Rawmaterial Process Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
...
<script type="text/javascript">
   ...
   function editRawmaterialProcessDetail(that) {
    ...
    function addRawmaterialProcessDetail() {
