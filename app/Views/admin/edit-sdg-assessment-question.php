    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Sdg Assessment Question Management</h1> </div>
            <!-- /.col -->
            <div class="col-sm-6">
...
if($session->get('error')){?>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Edit Sdg Assessment Question </h3> </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form name="frm-industry" id="industry" method="post" action="<?php echo base_url();?>/assessment/updateSdgAssessmentQuestion">
                          <input type="hidden" id="assessment_id" name="id" value="<?php echo $rs->id ?>" />
                          <div class="card-body">
                            <div class="form-group">
                              <label for="exampleInputEmail1">Select Industry </label>
                              <select name="industry_id" id="industry_id" required="required" class="form-control" onchange="getSdgAjax(this.value);">
                                <option value="">Select Industry </option>
                                <option value="0" <?=$rs->industry_id==0?'selected':'' ?>>All</option>
                                <?php if(!empty($industry)){

                          foreach($industry as $r){?>
                                  <option value="<?php echo $r['id'];?>" <?=$r[ 'id']==$rs->industry_id?'selected':'' ?>>
                                    <?php echo $r['industry_name'];?>
                                  </option>
                                  <?php  }
                            ...
                            <div class="form-group">
                              ...
                              <select name="location_id" id="location_id" required="required" class="form-control">
                                ...
                                <option value="0" <?=$rs->country_id==0?'selected':'' ?>>All</option>
                                <?php 
                          if($country) {
                            foreach($country as $c) {
                        ?>
                                  <option value="<?php echo $c['id'] ?>" <?=$c[ 'id']==$rs->country_id?'selected':'' ?>>
                                    <?php echo $c['name'] ?>
                                  </option>
                                  <?php                              
                            }
                        ...
                        ?>
                            ...
                            <div class="form-group">
                              ...
                              <select name="company_id" id="company_id" required="required" class="form-control">
                                <option value="">Select Industry </option>
                                <option value="0" <?=$rs->company_id==0?'selected':'' ?>>All</option>
                                <?php 
                          if($company) {
                            foreach($company as $c) {
                        ?>
                                  <option value="<?php echo $c['id'] ?>" <?=$c[ 'id']==$rs->company_id?'selected':'' ?>>
                                    <?php echo $c['company_size'] ?>
                                  </option>
                                  <?php                              
                            }
                          }
                        ?>
                            ...
                            <div class="form-group">
                              ...
                              <select name="sdg_id" id="sdgDiv" required="required" class="form-control" onchange="getIndicatorAjax(this.value);">
                                <option value="">Select Sdg </option>
                                <?php if(!empty($sdg)){

                          foreach($sdg as $r){?>
                                  <option value="<?php echo $r['id'];?>" <?=$r[ 'id']==$rs->sdg_id?'selected':'' ?>>
                                    <?php echo $r['sdg_name'];?>
                                  </option>
                                  <?php  }
                        ...
                        ?>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputEmail1" required="required" name="question_title" value="<?php echo $rs->question_title ?>"> </div>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Question</label>
                              <textarea class="form-control" id="exampleInputEmail1" required="required" name="question">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputEmail1" name="remark" value="<?php echo $rs->remark ?>"> </div>
                            <div class="form-group">
                          ...
                          foreach($disclosure as $r){?>
                                  <option value="<?php echo $r['id'];?>" <?=$r[ 'id']==$rs->disclosure_id?'selected':'' ?>>
                                    <?php echo $r['disclosure_name'];?>
                                  </option>
                                  <?php  }
                        }?>
                              </select>
            ...
            ?>
                            ...
                            </div> <span class="stand_and_classific_div"></span>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="col-md-5" style="float: left;">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="answer[]"> </div>
                              <div class="col-md-1" style="float: left;">
                                <label for="exampleInputEmail1">Marks</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="marks[]"> </textarea>
                              </div>
                              <div class="col-md-2" style="float: left;">
                            ...
                            </div> <span class="questionDiv"></span> </div>
                          <!-- /.card-body -->
    ...
    <?php include('include/footer.php');?>
      ...
      function getIndicatorAjax(id = 1) {
        $.ajax({
          url: "<?php echo base_url()?>/assessment/getIndicatorBySdg/" + id,
          type: "POST",
          //dataType: "JSON",
          success: function(data) {
            $('#indicatorDiv').html(data);
      ...
      function getSdgAjax(id = 1) {
        $.ajax({
          url: "<?php echo base_url()?>/assessment/getSdgByIndustry/" + id,
          type: "POST",
          //dataType: "JSON",
          success: function(data) {
            $('#sdgDiv').html(data);
