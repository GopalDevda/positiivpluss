            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <!-- <li class="breadcrumb-item active"><a href="#" onclick="addDisclosure()" class='btn btn-primary'><i class="fa fa-plus"></i> Add User Document limit</a> </li> -->
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($list as $d) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" onclick="editDisclosure($(this))" data-name='<?= $d['user_id']; ?>' data-limit='<?= $d['limit']; ?>' data-number='<?= $d['id']; ?>' data-unit='<?= $d['unit'] ?>'><i class="fa fa-pencil"></i></a>
                                                <a class="btn btn-danger" href="<?php echo base_url() ?>/master/delete_doc_model/<?php echo $d['id']; ?>" onclick="return confirm('Do you want to delete?');"><i class="fa fa-trash"></i>
                                                </a>
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" name="disclosure-form" id="disclosure-form" action="<?php echo base_url(); ?>/master/addlimitdocument">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_name" id="disclosure_category_id" required="required" class="form-control">
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" name="disclosure-form" id="disclosure-form" action="<?php echo base_url(); ?>/master/editlimitdocument">
                <div class="modal-body">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Limit</h3>
                        </div>
                        <div class="card-body">

                            <!-- <div class="form-group">
                                <label for="exampleInputEmail1">Select User</label>
                                <select name="edit_user_name" id="edit_user_id" required="required" class="form-control">
                                    <option value="">Select User </option>
                                    <?php foreach ($supplier as $supplier_id) { ?>
                                        <option value="<?= $supplier_id['id'] ?>"><?= $supplier_id['supplier_name'] ?></option>
                                    <?php
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1">Limit</label>
                                <div class="input-group mb-3">
                                    <input type="number" placeholder="Enter Site Area" name="edit_limit" class="form-control">
                                    <div class="input-group-text p-0" style="width:150px;">
                                        <select class="form-group shadow-none bg-light border-0" name="edit_unit" required>
                                            <option>Select Unit</option>
                                            <option value="1">KB</option>
...
<div class="modal fade" id="modal-addDisclosure">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" name="disclosure-form" id="disclosure-form" action="<?php echo base_url(); ?>/master/addSubDisclosureName">
                <div class="modal-body">
                    <div class="card card-primary">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" required="required" readonly class="form-control" placeholder="Enter Disclosure Name" name="name" id="disclosure_name_sub">
                            </div>
                            <div class="form-group">
                                <label for="sub_disclosure_name">Sub Disclosure Name</label>
                                <input type="text" required="required" class="form-control" placeholder="Enter Sub Disclosure Name" name="sub_disclosure_name" id="sub_disclosure_name">
                            </div>
...
<div class="modal fade" id="modal-editDisclosure">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" name="disclosure-form" id="disclosure-form" action="<?php echo base_url(); ?>/master/editSubDisclosureName">
                <div class="modal-body">
                    <div class="card card-primary">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <!--  <label for="sub_disclosure_name">Sub Disclosure Name</label> -->
                                <input type="hidden" required="required" class="form-control" placeholder="Enter Sub Disclosure Name" name="sub_disclosure_edit" id="edit_sub_disclosure_name">
                            </div>
...
<script type="text/javascript">
    ...
    function editDisclosure(that) {
        $('#edit_user_id').val(that.data('name')).change();
        $('[name=edit_limit]').val(that.data('limit'));
        $('[name=edit_unit]').val(that.data('unit')).change();
        $('#user_ids').val(that.data('number'));
