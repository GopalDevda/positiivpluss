        ...
        if ($control_data) {
            ...
            <img src="https://user.positiivplus.io/public/uploads/owner/john.jpg" alt="avatar">
                ...
                $data .= '</div>
                                                                                 ...
                                                                                 <td class="oooooo"  data-id="' . $control["start_date"] . '"><span class="badge rounded-pill badge-light-success me-1" >Active</span></td>
    ...
    public function standard($id)
    {
        ...
        if ($role == 0 || $role == 10) {
            ...
            foreach ($month_name_show as $item) {
                if (!in_array($item, $processed_ids)) { // check if ID has already been processed process data here
                    ...
                    if ($site_fil) {
                        ...
                        foreach ($month as $key => $mon_fi) {
                            ...
                            if (!$month_filt) {
                                ...
                                $img =  $model_doc->insert(['supplier_id' => $u_id, 'action_id' => '1', 'image' => $newName, 'indicator_id' => $indicator, 'title' => $title, 'status' => 1, 'document_type_id' => '19', 'document_name' => $doc_name, 'file_size' => $file_size, 'date' => date('Y-m-d')]);
