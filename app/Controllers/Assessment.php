...
class Assessment extends BaseController
{
    ...
    public function addAllAssessmentQuestion()
    {
        ...
        $indicator_category_id = $this->request->getVar('indicatid');

        $indicator_id = $this->request->getVar('indiid');
        // print_r($indicator_id);
        // print_r($indicator_category_id);
        // die();
        // $location = $this->request->getVar('location_id');
    ...
    public function viewAssessmentQuestion()
    {
        ...
        if (!empty($rs)) {
            ...
            foreach ($rs as $r) {
                ...
                if (!empty($disclosure)) {
                    $disclosure_name = $disclosure[0]['disclosure_name'];
                } else {
                    $disclosure_name = '';
                }
    ...
    public function viewallassessmentquestion($name)
    {
        ...
        if (!empty($rs)) {
            ...
            foreach ($rs as $r) {
                ...
                if (!empty($indicator_category)) {
                    $indicatory_category_name = $indicator_category[0]['indicator_category_name'];
                } else {
                    $indicatory_category_name = 0;
                }
    ...
    public function allassessmentQuestion($name)
    {
        ...
        $data['indi_cat_id'] = $queryAssessment[0]['indicator_category_id'];
        $data['indi_id'] = $queryAssessment[0]['indicator_id'];
