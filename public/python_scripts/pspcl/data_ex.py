...
# for F_path in Path(folder_path).glob("3004970817.pdf"):
    # print(F_path)
    ...
    if Ac_no1:
        ...
        # D_load1     =re.findall('Load\(80%\)\s+(\d+\.\d)',D_load)
        # D_load     =''.join(D_load1)

       

        print(Bill_amount)
        # Bill_amount     =''.join(Total_Amount1)
        ...
        Bill_amount_1      = pdf.pq('LTTextLineHorizontal:overlaps_bbox("470.524, 550.894, 550.093, 599.902")').text()
    ...
    db.close()
print('No more data')
#   account no : 3077118039
# Bill month : SEP_2023
# Month (Abbreviation): Sep
# Month (Numeric): 09
# Year: 2023
# 2023_09_13
# Bill amount : 17051.00
...
# UHBVN_3077118039_SEP_2023
#PSPCL Bill 3000001570 due on 2023-SEP-11
