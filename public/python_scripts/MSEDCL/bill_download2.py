...
if rows:
    ...
    prefs = {'printing.print_preview_sticky_settings.appState': json.dumps(settings), 'savefile.default_directory': '/var/www/html/public/python_scripts/MSEDCL/download'}
