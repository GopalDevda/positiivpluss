...
query = f"SELECT username, password,kn_no FROM sensors WHERE provider_type = '73' AND login_status = '2'AND download_month !='{current_month}' ;"  # Modify the query as per your table structure and conditions
