!function () {
   ...
   for (const i of t.features) {
      ...
      o.className = "marker", o.insertAdjacentHTML("afterbegin", '<img src="public/brand/assets/app-assets/map/maps-pin.jpg" alt="Fleet Car" width="20" class="rounded-3" id="carFleet-' + i.properties.message + '">'), o.style.width = s + "px", o.style.height = a + "px", o.style.cursor = "pointer", new mapboxgl.Marker(o).setLngLat(i.geometry.coordinates).addTo(r);
